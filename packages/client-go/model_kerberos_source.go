...
func NewKerberosSource(pk string, name string, slug string, component string, verboseName string, verboseNamePlural string, metaModelName string, managed NullableString, iconUrl NullableString, iconThemedUrls NullableThemedUrls, realm string, connectivity map[string]string) *KerberosSource {
	this := KerberosSource{}
	this.Pk = pk
	this.Name = name
	this.Slug = slug
