...
func NewKerberosSource(pk string, name string, slug string, component string, verboseName string, verboseNamePlural string, metaModelName string, managed NullableString, iconUrl NullableDynamicURL, realm string, connectivity map[string]string) *KerberosSource {
	this := KerberosSource{}
	this.Pk = pk
	this.Name = name
	this.Slug = slug
...
func (o *KerberosSource) GetIconUrl() DynamicURL {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *KerberosSource) GetIconUrlOk() (*DynamicURL, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *KerberosSource) SetIconUrl(v DynamicURL) {
	o.IconUrl.Set(&v)
}
