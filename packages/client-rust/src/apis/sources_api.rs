...
pub async fn sources_all_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<SourcesAllDestroyError>> {
    ...
    let uri_str = format!("{}/sources/all/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
...
/// Source Viewset
pub async fn sources_all_list(configuration: &configuration::Configuration, managed: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, search: Option<&str>, slug: Option<&str>) -> Result<models::PaginatedSourceList, Error<SourcesAllListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn sources_all_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::Source, Error<SourcesAllRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Source`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Source`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn sources_all_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<SourcesAllUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/all/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_group_connections_all_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesGroupConnectionsAllDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/all/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsAllDestroyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_all_list(configuration: &configuration::Configuration, group: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>) -> Result<models::PaginatedGroupSourceConnectionList, Error<SourcesGroupConnectionsAllListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginatedGroupSourceConnectionList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginatedGroupSourceConnectionList`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsAllListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_all_partial_update(configuration: &configuration::Configuration, id: i32, patched_group_source_connection_request: Option<models::PatchedGroupSourceConnectionRequest>) -> Result<models::GroupSourceConnection, Error<SourcesGroupConnectionsAllPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GroupSourceConnection`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GroupSourceConnection`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsAllPartialUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_all_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::GroupSourceConnection, Error<SourcesGroupConnectionsAllRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsAllRetrieveError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_all_update(configuration: &configuration::Configuration, id: i32, group_source_connection_request: models::GroupSourceConnectionRequest) -> Result<models::GroupSourceConnection, Error<SourcesGroupConnectionsAllUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsAllUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get a list of all objects that use this object
pub async fn sources_group_connections_all_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesGroupConnectionsAllUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/all/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsAllUsedByListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_kerberos_create(configuration: &configuration::Configuration, group_kerberos_source_connection_request: models::GroupKerberosSourceConnectionRequest) -> Result<models::GroupKerberosSourceConnection, Error<SourcesGroupConnectionsKerberosCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsKerberosCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_kerberos_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesGroupConnectionsKerberosDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/kerberos/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_kerberos_list(configuration: &configuration::Configuration, group: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>) -> Result<models::PaginatedGroupKerberosSourceConnectionList, Error<SourcesGroupConnectionsKerberosListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_group = group;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_kerberos_partial_update(configuration: &configuration::Configuration, id: i32, patched_group_kerberos_source_connection_request: Option<models::PatchedGroupKerberosSourceConnectionRequest>) -> Result<models::GroupKerberosSourceConnection, Error<SourcesGroupConnectionsKerberosPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_kerberos_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::GroupKerberosSourceConnection, Error<SourcesGroupConnectionsKerberosRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_kerberos_update(configuration: &configuration::Configuration, id: i32, group_kerberos_source_connection_request: models::GroupKerberosSourceConnectionRequest) -> Result<models::GroupKerberosSourceConnection, Error<SourcesGroupConnectionsKerberosUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_group_kerberos_source_connection_request = group_kerberos_source_connection_request;
...
/// Get a list of all objects that use this object
pub async fn sources_group_connections_kerberos_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesGroupConnectionsKerberosUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/kerberos/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_ldap_create(configuration: &configuration::Configuration, group_ldap_source_connection_request: models::GroupLdapSourceConnectionRequest) -> Result<models::GroupLdapSourceConnection, Error<SourcesGroupConnectionsLdapCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_group_ldap_source_connection_request = group_ldap_source_connection_request;

    let uri_str = format!("{}/sources/group_connections/ldap/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GroupLdapSourceConnection`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GroupLdapSourceConnection`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsLdapCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_ldap_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesGroupConnectionsLdapDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/ldap/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsLdapDestroyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_ldap_list(configuration: &configuration::Configuration, group: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>) -> Result<models::PaginatedGroupLdapSourceConnectionList, Error<SourcesGroupConnectionsLdapListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_group = group;
    let p_query_ordering = ordering;
    let p_query_page = page;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginatedGroupLdapSourceConnectionList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginatedGroupLdapSourceConnectionList`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsLdapListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_ldap_partial_update(configuration: &configuration::Configuration, id: i32, patched_group_ldap_source_connection_request: Option<models::PatchedGroupLdapSourceConnectionRequest>) -> Result<models::GroupLdapSourceConnection, Error<SourcesGroupConnectionsLdapPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_patched_group_ldap_source_connection_request = patched_group_ldap_source_connection_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsLdapPartialUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_ldap_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::GroupLdapSourceConnection, Error<SourcesGroupConnectionsLdapRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsLdapRetrieveError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_ldap_update(configuration: &configuration::Configuration, id: i32, group_ldap_source_connection_request: models::GroupLdapSourceConnectionRequest) -> Result<models::GroupLdapSourceConnection, Error<SourcesGroupConnectionsLdapUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_group_ldap_source_connection_request = group_ldap_source_connection_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsLdapUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get a list of all objects that use this object
pub async fn sources_group_connections_ldap_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesGroupConnectionsLdapUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/ldap/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsLdapUsedByListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_oauth_create(configuration: &configuration::Configuration, group_o_auth_source_connection_request: models::GroupOAuthSourceConnectionRequest) -> Result<models::GroupOAuthSourceConnection, Error<SourcesGroupConnectionsOauthCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Group-source connection Viewset
pub async fn sources_group_connections_oauth_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesGroupConnectionsOauthDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/oauth/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_oauth_list(configuration: &configuration::Configuration, group: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>) -> Result<models::PaginatedGroupOAuthSourceConnectionList, Error<SourcesGroupConnectionsOauthListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_group = group;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_oauth_partial_update(configuration: &configuration::Configuration, id: i32, patched_group_o_auth_source_connection_request: Option<models::PatchedGroupOAuthSourceConnectionRequest>) -> Result<models::GroupOAuthSourceConnection, Error<SourcesGroupConnectionsOauthPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_oauth_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::GroupOAuthSourceConnection, Error<SourcesGroupConnectionsOauthRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_oauth_update(configuration: &configuration::Configuration, id: i32, group_o_auth_source_connection_request: models::GroupOAuthSourceConnectionRequest) -> Result<models::GroupOAuthSourceConnection, Error<SourcesGroupConnectionsOauthUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_group_o_auth_source_connection_request = group_o_auth_source_connection_request;
...
/// Get a list of all objects that use this object
pub async fn sources_group_connections_oauth_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesGroupConnectionsOauthUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/oauth/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_plex_create(configuration: &configuration::Configuration, group_plex_source_connection_request: models::GroupPlexSourceConnectionRequest) -> Result<models::GroupPlexSourceConnection, Error<SourcesGroupConnectionsPlexCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Group-source connection Viewset
pub async fn sources_group_connections_plex_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesGroupConnectionsPlexDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/plex/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_plex_list(configuration: &configuration::Configuration, group: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>) -> Result<models::PaginatedGroupPlexSourceConnectionList, Error<SourcesGroupConnectionsPlexListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_group = group;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_plex_partial_update(configuration: &configuration::Configuration, id: i32, patched_group_plex_source_connection_request: Option<models::PatchedGroupPlexSourceConnectionRequest>) -> Result<models::GroupPlexSourceConnection, Error<SourcesGroupConnectionsPlexPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_plex_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::GroupPlexSourceConnection, Error<SourcesGroupConnectionsPlexRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_plex_update(configuration: &configuration::Configuration, id: i32, group_plex_source_connection_request: models::GroupPlexSourceConnectionRequest) -> Result<models::GroupPlexSourceConnection, Error<SourcesGroupConnectionsPlexUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_group_plex_source_connection_request = group_plex_source_connection_request;
...
/// Get a list of all objects that use this object
pub async fn sources_group_connections_plex_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesGroupConnectionsPlexUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/plex/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_saml_create(configuration: &configuration::Configuration, group_saml_source_connection_request: models::GroupSamlSourceConnectionRequest) -> Result<models::GroupSamlSourceConnection, Error<SourcesGroupConnectionsSamlCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesGroupConnectionsSamlCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Group-source connection Viewset
pub async fn sources_group_connections_saml_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesGroupConnectionsSamlDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/saml/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_saml_list(configuration: &configuration::Configuration, group: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>) -> Result<models::PaginatedGroupSamlSourceConnectionList, Error<SourcesGroupConnectionsSamlListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_group = group;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_saml_partial_update(configuration: &configuration::Configuration, id: i32, patched_group_saml_source_connection_request: Option<models::PatchedGroupSamlSourceConnectionRequest>) -> Result<models::GroupSamlSourceConnection, Error<SourcesGroupConnectionsSamlPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_saml_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::GroupSamlSourceConnection, Error<SourcesGroupConnectionsSamlRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_saml_update(configuration: &configuration::Configuration, id: i32, group_saml_source_connection_request: models::GroupSamlSourceConnectionRequest) -> Result<models::GroupSamlSourceConnection, Error<SourcesGroupConnectionsSamlUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_group_saml_source_connection_request = group_saml_source_connection_request;
...
/// Get a list of all objects that use this object
pub async fn sources_group_connections_saml_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesGroupConnectionsSamlUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/saml/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_telegram_create(configuration: &configuration::Configuration, group_telegram_source_connection_request: models::GroupTelegramSourceConnectionRequest) -> Result<models::GroupTelegramSourceConnection, Error<SourcesGroupConnectionsTelegramCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Group-source connection Viewset
pub async fn sources_group_connections_telegram_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesGroupConnectionsTelegramDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/telegram/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Group-source connection Viewset
pub async fn sources_group_connections_telegram_list(configuration: &configuration::Configuration, group: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>) -> Result<models::PaginatedGroupTelegramSourceConnectionList, Error<SourcesGroupConnectionsTelegramListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_group = group;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_telegram_partial_update(configuration: &configuration::Configuration, id: i32, patched_group_telegram_source_connection_request: Option<models::PatchedGroupTelegramSourceConnectionRequest>) -> Result<models::GroupTelegramSourceConnection, Error<SourcesGroupConnectionsTelegramPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_telegram_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::GroupTelegramSourceConnection, Error<SourcesGroupConnectionsTelegramRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Group-source connection Viewset
pub async fn sources_group_connections_telegram_update(configuration: &configuration::Configuration, id: i32, group_telegram_source_connection_request: models::GroupTelegramSourceConnectionRequest) -> Result<models::GroupTelegramSourceConnection, Error<SourcesGroupConnectionsTelegramUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_group_telegram_source_connection_request = group_telegram_source_connection_request;
...
/// Get a list of all objects that use this object
pub async fn sources_group_connections_telegram_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesGroupConnectionsTelegramUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/group_connections/telegram/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_kerberos_create(configuration: &configuration::Configuration, kerberos_source_request: models::KerberosSourceRequest) -> Result<models::KerberosSource, Error<SourcesKerberosCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::KerberosSource`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::KerberosSource`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Kerberos Source Viewset
pub async fn sources_kerberos_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<SourcesKerberosDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/sources/kerberos/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Kerberos Source Viewset
pub async fn sources_kerberos_list(configuration: &configuration::Configuration, enabled: Option<bool>, kadmin_type: Option<models::KadminTypeEnum>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, password_login_update_internal_password: Option<bool>, pbm_uuid: Option<&str>, realm: Option<&str>, search: Option<&str>, slug: Option<&str>, spnego_server_name: Option<&str>, sync_principal: Option<&str>, sync_users: Option<bool>, sync_users_password: Option<bool>) -> Result<models::PaginatedKerberosSourceList, Error<SourcesKerberosListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Kerberos Source Viewset
pub async fn sources_kerberos_partial_update(configuration: &configuration::Configuration, slug: &str, patched_kerberos_source_request: Option<models::PatchedKerberosSourceRequest>) -> Result<models::KerberosSource, Error<SourcesKerberosPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
...
/// Kerberos Source Viewset
pub async fn sources_kerberos_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::KerberosSource, Error<SourcesKerberosRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
...
pub async fn sources_kerberos_sync_status_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::SyncStatus, Error<SourcesKerberosSyncStatusRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/sources/kerberos/{slug}/sync/status/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SyncStatus`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SyncStatus`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Kerberos Source Viewset
pub async fn sources_kerberos_update(configuration: &configuration::Configuration, slug: &str, kerberos_source_request: models::KerberosSourceRequest) -> Result<models::KerberosSource, Error<SourcesKerberosUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
    let p_body_kerberos_source_request = kerberos_source_request;
...
/// Get a list of all objects that use this object
pub async fn sources_kerberos_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<SourcesKerberosUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/sources/kerberos/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_ldap_create(configuration: &configuration::Configuration, ldap_source_request: models::LdapSourceRequest) -> Result<models::LdapSource, Error<SourcesLdapCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::LdapSource`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::LdapSource`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn sources_ldap_debug_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::LdapDebug, Error<SourcesLdapDebugRetrieveError>> {
    ...
    let uri_str = format!("{}/sources/ldap/{slug}/debug/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::LdapDebug`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::LdapDebug`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn sources_ldap_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<SourcesLdapDestroyError>> {
    ...
    let uri_str = format!("{}/sources/ldap/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// LDAP Source Viewset
pub async fn sources_ldap_list(configuration: &configuration::Configuration, additional_group_dn: Option<&str>, additional_user_dn: Option<&str>, base_dn: Option<&str>, bind_cn: Option<&str>, client_certificate: Option<&str>, delete_not_found_objects: Option<bool>, enabled: Option<bool>, group_membership_field: Option<&str>, group_object_filter: Option<&str>, group_property_mappings: Option<Vec<uuid::Uuid>>, lookup_groups_from_user: Option<bool>, name: Option<&str>, object_uniqueness_field: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, password_login_update_internal_password: Option<bool>, pbm_uuid: Option<&str>, peer_certificate: Option<&str>, search: Option<&str>, server_uri: Option<&str>, slug: Option<&str>, sni: Option<bool>, start_tls: Option<bool>, sync_groups: Option<bool>, sync_parent_group: Option<&str>, sync_users: Option<bool>, sync_users_password: Option<bool>, user_membership_attribute: Option<&str>, user_object_filter: Option<&str>, user_property_mappings: Option<Vec<uuid::Uuid>>) -> Result<models::PaginatedLdapSourceList, Error<SourcesLdapListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_group_property_mappings {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("group_property_mappings".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("group_property_mappings", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref param_value) = p_query_user_property_mappings {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("user_property_mappings".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("user_property_mappings", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
...
/// Get provider's sync status
pub async fn sources_ldap_sync_status_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::SyncStatus, Error<SourcesLdapSyncStatusRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/sources/ldap/{slug}/sync/status/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_ldap_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<SourcesLdapUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/ldap/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_oauth_create(configuration: &configuration::Configuration, o_auth_source_request: models::OAuthSourceRequest) -> Result<models::OAuthSource, Error<SourcesOauthCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::OAuthSource`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::OAuthSource`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn sources_oauth_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<SourcesOauthDestroyError>> {
    ...
    let uri_str = format!("{}/sources/oauth/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Source Viewset
pub async fn sources_oauth_list(configuration: &configuration::Configuration, access_token_url: Option<&str>, additional_scopes: Option<&str>, authentication_flow: Option<&str>, authorization_url: Option<&str>, consumer_key: Option<&str>, enabled: Option<bool>, enrollment_flow: Option<&str>, group_matching_mode: Option<models::GroupMatchingModeEnum>, has_jwks: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, policy_engine_mode: Option<models::PolicyEngineMode>, profile_url: Option<&str>, provider_type: Option<&str>, request_token_url: Option<&str>, search: Option<&str>, slug: Option<&str>, user_matching_mode: Option<models::UserMatchingModeEnum>) -> Result<models::PaginatedOAuthSourceList, Error<SourcesOauthListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn sources_oauth_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<SourcesOauthUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/oauth/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_plex_create(configuration: &configuration::Configuration, plex_source_request: models::PlexSourceRequest) -> Result<models::PlexSource, Error<SourcesPlexCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PlexSource`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PlexSource`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn sources_plex_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<SourcesPlexDestroyError>> {
    ...
    let uri_str = format!("{}/sources/plex/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Plex source Viewset
pub async fn sources_plex_list(configuration: &configuration::Configuration, allow_friends: Option<bool>, authentication_flow: Option<&str>, client_id: Option<&str>, enabled: Option<bool>, enrollment_flow: Option<&str>, group_matching_mode: Option<models::GroupMatchingModeEnum>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, policy_engine_mode: Option<models::PolicyEngineMode>, search: Option<&str>, slug: Option<&str>, user_matching_mode: Option<models::UserMatchingModeEnum>) -> Result<models::PaginatedPlexSourceList, Error<SourcesPlexListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn sources_plex_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<SourcesPlexUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/plex/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_saml_create(configuration: &configuration::Configuration, saml_source_request: models::SamlSourceRequest) -> Result<models::SamlSource, Error<SourcesSamlCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SamlSource`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SamlSource`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn sources_saml_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<SourcesSamlDestroyError>> {
    ...
    let uri_str = format!("{}/sources/saml/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SAMLSource Viewset
pub async fn sources_saml_list(configuration: &configuration::Configuration, allow_idp_initiated: Option<bool>, authentication_flow: Option<&str>, binding_type: Option<models::BindingTypeEnum>, digest_algorithm: Option<models::DigestAlgorithmEnum>, enabled: Option<bool>, enrollment_flow: Option<&str>, force_authn: Option<bool>, issuer: Option<&str>, managed: Option<&str>, name: Option<&str>, name_id_policy: Option<models::SamlNameIdPolicyEnum>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, policy_engine_mode: Option<models::PolicyEngineMode>, pre_authentication_flow: Option<&str>, search: Option<&str>, signature_algorithm: Option<models::SignatureAlgorithmEnum>, signed_assertion: Option<bool>, signed_response: Option<bool>, signing_kp: Option<&str>, slo_url: Option<&str>, slug: Option<&str>, sso_url: Option<&str>, temporary_user_delete_after: Option<&str>, user_matching_mode: Option<models::UserMatchingModeEnum>, verification_kp: Option<&str>) -> Result<models::PaginatedSamlSourceList, Error<SourcesSamlListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn sources_saml_metadata_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::SamlMetadata, Error<SourcesSamlMetadataRetrieveError>> {
    ...
    let uri_str = format!("{}/sources/saml/{slug}/metadata/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SamlMetadata`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SamlMetadata`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn sources_saml_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<SourcesSamlUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/saml/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// SCIMSource Viewset
pub async fn sources_scim_create(configuration: &configuration::Configuration, scim_source_request: models::ScimSourceRequest) -> Result<models::ScimSource, Error<SourcesScimCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScimSource`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScimSource`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// SCIMSource Viewset
pub async fn sources_scim_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<SourcesScimDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/sources/scim/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn sources_scim_groups_create(configuration: &configuration::Configuration, scim_source_group_request: models::ScimSourceGroupRequest) -> Result<models::ScimSourceGroup, Error<SourcesScimGroupsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScimSourceGroup`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScimSourceGroup`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// SCIMSourceGroup Viewset
pub async fn sources_scim_groups_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<SourcesScimGroupsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/scim_groups/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SCIMSourceGroup Viewset
pub async fn sources_scim_groups_list(configuration: &configuration::Configuration, group__group_uuid: Option<&str>, group__name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>) -> Result<models::PaginatedScimSourceGroupList, Error<SourcesScimGroupsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SCIMSourceGroup Viewset
pub async fn sources_scim_groups_partial_update(configuration: &configuration::Configuration, id: &str, patched_scim_source_group_request: Option<models::PatchedScimSourceGroupRequest>) -> Result<models::ScimSourceGroup, Error<SourcesScimGroupsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// SCIMSourceGroup Viewset
pub async fn sources_scim_groups_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::ScimSourceGroup, Error<SourcesScimGroupsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// SCIMSourceGroup Viewset
pub async fn sources_scim_groups_update(configuration: &configuration::Configuration, id: &str, scim_source_group_request: models::ScimSourceGroupRequest) -> Result<models::ScimSourceGroup, Error<SourcesScimGroupsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_scim_source_group_request = scim_source_group_request;
...
/// Get a list of all objects that use this object
pub async fn sources_scim_groups_used_by_list(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::UsedBy>, Error<SourcesScimGroupsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/scim_groups/{id}/used_by/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// SCIMSource Viewset
pub async fn sources_scim_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, search: Option<&str>, slug: Option<&str>) -> Result<models::PaginatedScimSourceList, Error<SourcesScimListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// SCIMSource Viewset
pub async fn sources_scim_partial_update(configuration: &configuration::Configuration, slug: &str, patched_scim_source_request: Option<models::PatchedScimSourceRequest>) -> Result<models::ScimSource, Error<SourcesScimPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
...
/// SCIMSource Viewset
pub async fn sources_scim_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::ScimSource, Error<SourcesScimRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
...
/// SCIMSource Viewset
pub async fn sources_scim_update(configuration: &configuration::Configuration, slug: &str, scim_source_request: models::ScimSourceRequest) -> Result<models::ScimSource, Error<SourcesScimUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
    let p_body_scim_source_request = scim_source_request;
...
/// Get a list of all objects that use this object
pub async fn sources_scim_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<SourcesScimUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/sources/scim/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_scim_users_create(configuration: &configuration::Configuration, scim_source_user_request: models::ScimSourceUserRequest) -> Result<models::ScimSourceUser, Error<SourcesScimUsersCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScimSourceUser`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScimSourceUser`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// SCIMSourceUser Viewset
pub async fn sources_scim_users_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<SourcesScimUsersDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/scim_users/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SCIMSourceUser Viewset
pub async fn sources_scim_users_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>, user__id: Option<i32>, user__username: Option<&str>) -> Result<models::PaginatedScimSourceUserList, Error<SourcesScimUsersListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// SCIMSourceUser Viewset
pub async fn sources_scim_users_partial_update(configuration: &configuration::Configuration, id: &str, patched_scim_source_user_request: Option<models::PatchedScimSourceUserRequest>) -> Result<models::ScimSourceUser, Error<SourcesScimUsersPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// SCIMSourceUser Viewset
pub async fn sources_scim_users_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::ScimSourceUser, Error<SourcesScimUsersRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// SCIMSourceUser Viewset
pub async fn sources_scim_users_update(configuration: &configuration::Configuration, id: &str, scim_source_user_request: models::ScimSourceUserRequest) -> Result<models::ScimSourceUser, Error<SourcesScimUsersUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_scim_source_user_request = scim_source_user_request;
...
/// Get a list of all objects that use this object
pub async fn sources_scim_users_used_by_list(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::UsedBy>, Error<SourcesScimUsersUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/scim_users/{id}/used_by/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_telegram_connect_user_create(configuration: &configuration::Configuration, slug: &str, telegram_auth_request: models::TelegramAuthRequest) -> Result<models::UserTelegramSourceConnection, Error<SourcesTelegramConnectUserCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
    let p_body_telegram_auth_request = telegram_auth_request;

    let uri_str = format!("{}/sources/telegram/{slug}/connect_user/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesTelegramConnectUserCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn sources_telegram_create(configuration: &configuration::Configuration, telegram_source_request: models::TelegramSourceRequest) -> Result<models::TelegramSource, Error<SourcesTelegramCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::TelegramSource`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::TelegramSource`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn sources_telegram_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<SourcesTelegramDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/sources/telegram/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn sources_telegram_list(configuration: &configuration::Configuration, authentication_flow: Option<&str>, bot_username: Option<&str>, enabled: Option<bool>, enrollment_flow: Option<&str>, group_matching_mode: Option<models::GroupMatchingModeEnum>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, policy_engine_mode: Option<models::PolicyEngineMode>, request_message_access: Option<bool>, search: Option<&str>, slug: Option<&str>, user_matching_mode: Option<models::UserMatchingModeEnum>) -> Result<models::PaginatedTelegramSourceList, Error<SourcesTelegramListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_authentication_flow = authentication_flow;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn sources_telegram_partial_update(configuration: &configuration::Configuration, slug: &str, patched_telegram_source_request: Option<models::PatchedTelegramSourceRequest>) -> Result<models::TelegramSource, Error<SourcesTelegramPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn sources_telegram_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::TelegramSource, Error<SourcesTelegramRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn sources_telegram_update(configuration: &configuration::Configuration, slug: &str, telegram_source_request: models::TelegramSourceRequest) -> Result<models::TelegramSource, Error<SourcesTelegramUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;
    let p_body_telegram_source_request = telegram_source_request;
...
/// Get a list of all objects that use this object
pub async fn sources_telegram_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<SourcesTelegramUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/sources/telegram/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_user_connections_all_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesUserConnectionsAllDestroyError>> {
    ...
    let uri_str = format!("{}/sources/user_connections/all/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_all_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>, user: Option<i32>) -> Result<models::PaginatedUserSourceConnectionList, Error<SourcesUserConnectionsAllListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// User-source connection Viewset
pub async fn sources_user_connections_all_partial_update(configuration: &configuration::Configuration, id: i32, patched_user_source_connection_request: Option<models::PatchedUserSourceConnectionRequest>) -> Result<models::UserSourceConnection, Error<SourcesUserConnectionsAllPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// User-source connection Viewset
pub async fn sources_user_connections_all_update(configuration: &configuration::Configuration, id: i32, user_source_connection_request: models::UserSourceConnectionRequest) -> Result<models::UserSourceConnection, Error<SourcesUserConnectionsAllUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn sources_user_connections_all_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesUserConnectionsAllUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/user_connections/all/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_kerberos_create(configuration: &configuration::Configuration, user_kerberos_source_connection_request: models::UserKerberosSourceConnectionRequest) -> Result<models::UserKerberosSourceConnection, Error<SourcesUserConnectionsKerberosCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// User-source connection Viewset
pub async fn sources_user_connections_kerberos_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesUserConnectionsKerberosDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/user_connections/kerberos/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_kerberos_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>, user: Option<i32>) -> Result<models::PaginatedUserKerberosSourceConnectionList, Error<SourcesUserConnectionsKerberosListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// User-source connection Viewset
pub async fn sources_user_connections_kerberos_partial_update(configuration: &configuration::Configuration, id: i32, patched_user_kerberos_source_connection_request: Option<models::PatchedUserKerberosSourceConnectionRequest>) -> Result<models::UserKerberosSourceConnection, Error<SourcesUserConnectionsKerberosPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// User-source connection Viewset
pub async fn sources_user_connections_kerberos_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::UserKerberosSourceConnection, Error<SourcesUserConnectionsKerberosRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// User-source connection Viewset
pub async fn sources_user_connections_kerberos_update(configuration: &configuration::Configuration, id: i32, user_kerberos_source_connection_request: models::UserKerberosSourceConnectionRequest) -> Result<models::UserKerberosSourceConnection, Error<SourcesUserConnectionsKerberosUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_user_kerberos_source_connection_request = user_kerberos_source_connection_request;
...
/// Get a list of all objects that use this object
pub async fn sources_user_connections_kerberos_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesUserConnectionsKerberosUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/user_connections/kerberos/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_ldap_create(configuration: &configuration::Configuration, user_ldap_source_connection_request: models::UserLdapSourceConnectionRequest) -> Result<models::UserLdapSourceConnection, Error<SourcesUserConnectionsLdapCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserLdapSourceConnection`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserLdapSourceConnection`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SourcesUserConnectionsLdapCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// User-source connection Viewset
pub async fn sources_user_connections_ldap_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesUserConnectionsLdapDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/user_connections/ldap/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesUserConnectionsLdapDestroyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// User-source connection Viewset
pub async fn sources_user_connections_ldap_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>, user: Option<i32>) -> Result<models::PaginatedUserLdapSourceConnectionList, Error<SourcesUserConnectionsLdapListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginatedUserLdapSourceConnectionList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginatedUserLdapSourceConnectionList`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SourcesUserConnectionsLdapListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// User-source connection Viewset
pub async fn sources_user_connections_ldap_partial_update(configuration: &configuration::Configuration, id: i32, patched_user_ldap_source_connection_request: Option<models::PatchedUserLdapSourceConnectionRequest>) -> Result<models::UserLdapSourceConnection, Error<SourcesUserConnectionsLdapPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_patched_user_ldap_source_connection_request = patched_user_ldap_source_connection_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesUserConnectionsLdapPartialUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// User-source connection Viewset
pub async fn sources_user_connections_ldap_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::UserLdapSourceConnection, Error<SourcesUserConnectionsLdapRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesUserConnectionsLdapRetrieveError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// User-source connection Viewset
pub async fn sources_user_connections_ldap_update(configuration: &configuration::Configuration, id: i32, user_ldap_source_connection_request: models::UserLdapSourceConnectionRequest) -> Result<models::UserLdapSourceConnection, Error<SourcesUserConnectionsLdapUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_user_ldap_source_connection_request = user_ldap_source_connection_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesUserConnectionsLdapUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get a list of all objects that use this object
pub async fn sources_user_connections_ldap_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesUserConnectionsLdapUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/user_connections/ldap/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SourcesUserConnectionsLdapUsedByListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn sources_user_connections_oauth_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesUserConnectionsOauthDestroyError>> {
    ...
    let uri_str = format!("{}/sources/user_connections/oauth/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_oauth_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>, user: Option<i32>) -> Result<models::PaginatedUserOAuthSourceConnectionList, Error<SourcesUserConnectionsOauthListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
pub async fn sources_user_connections_oauth_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesUserConnectionsOauthUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/user_connections/oauth/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_plex_create(configuration: &configuration::Configuration, user_plex_source_connection_request: models::UserPlexSourceConnectionRequest) -> Result<models::UserPlexSourceConnection, Error<SourcesUserConnectionsPlexCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn sources_user_connections_plex_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesUserConnectionsPlexDestroyError>> {
    ...
    let uri_str = format!("{}/sources/user_connections/plex/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_plex_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>, user: Option<i32>) -> Result<models::PaginatedUserPlexSourceConnectionList, Error<SourcesUserConnectionsPlexListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// User-source connection Viewset
pub async fn sources_user_connections_plex_partial_update(configuration: &configuration::Configuration, id: i32, patched_user_plex_source_connection_request: Option<models::PatchedUserPlexSourceConnectionRequest>) -> Result<models::UserPlexSourceConnection, Error<SourcesUserConnectionsPlexPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// User-source connection Viewset
pub async fn sources_user_connections_plex_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::UserPlexSourceConnection, Error<SourcesUserConnectionsPlexRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// User-source connection Viewset
pub async fn sources_user_connections_plex_update(configuration: &configuration::Configuration, id: i32, user_plex_source_connection_request: models::UserPlexSourceConnectionRequest) -> Result<models::UserPlexSourceConnection, Error<SourcesUserConnectionsPlexUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_user_plex_source_connection_request = user_plex_source_connection_request;
...
pub async fn sources_user_connections_plex_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesUserConnectionsPlexUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/user_connections/plex/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn sources_user_connections_saml_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesUserConnectionsSamlDestroyError>> {
    ...
    let uri_str = format!("{}/sources/user_connections/saml/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_saml_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>, user: Option<i32>) -> Result<models::PaginatedUserSamlSourceConnectionList, Error<SourcesUserConnectionsSamlListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
pub async fn sources_user_connections_saml_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesUserConnectionsSamlUsedByListError>> {
    ...
    let uri_str = format!("{}/sources/user_connections/saml/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_telegram_create(configuration: &configuration::Configuration, user_telegram_source_connection_request: models::UserTelegramSourceConnectionRequest) -> Result<models::UserTelegramSourceConnection, Error<SourcesUserConnectionsTelegramCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// User-source connection Viewset
pub async fn sources_user_connections_telegram_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<SourcesUserConnectionsTelegramDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/user_connections/telegram/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// User-source connection Viewset
pub async fn sources_user_connections_telegram_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, source__slug: Option<&str>, user: Option<i32>) -> Result<models::PaginatedUserTelegramSourceConnectionList, Error<SourcesUserConnectionsTelegramListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// User-source connection Viewset
pub async fn sources_user_connections_telegram_partial_update(configuration: &configuration::Configuration, id: i32, patched_user_telegram_source_connection_request: Option<models::PatchedUserTelegramSourceConnectionRequest>) -> Result<models::UserTelegramSourceConnection, Error<SourcesUserConnectionsTelegramPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// User-source connection Viewset
pub async fn sources_user_connections_telegram_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::UserTelegramSourceConnection, Error<SourcesUserConnectionsTelegramRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// User-source connection Viewset
pub async fn sources_user_connections_telegram_update(configuration: &configuration::Configuration, id: i32, user_telegram_source_connection_request: models::UserTelegramSourceConnectionRequest) -> Result<models::UserTelegramSourceConnection, Error<SourcesUserConnectionsTelegramUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_user_telegram_source_connection_request = user_telegram_source_connection_request;
...
/// Get a list of all objects that use this object
pub async fn sources_user_connections_telegram_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<SourcesUserConnectionsTelegramUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/sources/user_connections/telegram/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
