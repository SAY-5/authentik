...
/// struct for typed errors of method [`stages_account_lockdown_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StagesAccountLockdownCreateError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`stages_account_lockdown_destroy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StagesAccountLockdownDestroyError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`stages_account_lockdown_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StagesAccountLockdownListError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`stages_account_lockdown_partial_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StagesAccountLockdownPartialUpdateError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`stages_account_lockdown_retrieve`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StagesAccountLockdownRetrieveError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`stages_account_lockdown_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StagesAccountLockdownUpdateError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`stages_account_lockdown_used_by_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StagesAccountLockdownUsedByListError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}
...
pub async fn stages_account_lockdown_create(configuration: &configuration::Configuration, account_lockdown_stage_request: models::AccountLockdownStageRequest) -> Result<models::AccountLockdownStage, Error<StagesAccountLockdownCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_account_lockdown_stage_request = account_lockdown_stage_request;

    let uri_str = format!("{}/stages/account_lockdown/", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_account_lockdown_stage_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AccountLockdownStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AccountLockdownStage`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<StagesAccountLockdownCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// AccountLockdownStage Viewset
pub async fn stages_account_lockdown_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAccountLockdownDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/account_lockdown/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<StagesAccountLockdownDestroyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// AccountLockdownStage Viewset
pub async fn stages_account_lockdown_list(configuration: &configuration::Configuration, deactivate_user: Option<bool>, delete_sessions: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, revoke_tokens: Option<bool>, search: Option<&str>, self_service_completion_flow: Option<&str>, self_service_message: Option<&str>, self_service_message_title: Option<&str>, set_unusable_password: Option<bool>, stage_uuid: Option<&str>) -> Result<models::PaginatedAccountLockdownStageList, Error<StagesAccountLockdownListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_deactivate_user = deactivate_user;
    let p_query_delete_sessions = delete_sessions;
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
    let p_query_revoke_tokens = revoke_tokens;
    let p_query_search = search;
    let p_query_self_service_completion_flow = self_service_completion_flow;
    let p_query_self_service_message = self_service_message;
    let p_query_self_service_message_title = self_service_message_title;
    let p_query_set_unusable_password = set_unusable_password;
    let p_query_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/account_lockdown/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_deactivate_user {
        req_builder = req_builder.query(&[("deactivate_user", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_delete_sessions {
        req_builder = req_builder.query(&[("delete_sessions", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_query_revoke_tokens {
        req_builder = req_builder.query(&[("revoke_tokens", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_search {
        req_builder = req_builder.query(&[("search", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_self_service_completion_flow {
        req_builder = req_builder.query(&[("self_service_completion_flow", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_self_service_message {
        req_builder = req_builder.query(&[("self_service_message", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_self_service_message_title {
        req_builder = req_builder.query(&[("self_service_message_title", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_set_unusable_password {
        req_builder = req_builder.query(&[("set_unusable_password", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginatedAccountLockdownStageList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginatedAccountLockdownStageList`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<StagesAccountLockdownListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// AccountLockdownStage Viewset
pub async fn stages_account_lockdown_partial_update(configuration: &configuration::Configuration, stage_uuid: &str, patched_account_lockdown_stage_request: Option<models::PatchedAccountLockdownStageRequest>) -> Result<models::AccountLockdownStage, Error<StagesAccountLockdownPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_patched_account_lockdown_stage_request = patched_account_lockdown_stage_request;
    ...
    req_builder = req_builder.json(&p_body_patched_account_lockdown_stage_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<StagesAccountLockdownPartialUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// AccountLockdownStage Viewset
pub async fn stages_account_lockdown_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::AccountLockdownStage, Error<StagesAccountLockdownRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<StagesAccountLockdownRetrieveError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// AccountLockdownStage Viewset
pub async fn stages_account_lockdown_update(configuration: &configuration::Configuration, stage_uuid: &str, account_lockdown_stage_request: models::AccountLockdownStageRequest) -> Result<models::AccountLockdownStage, Error<StagesAccountLockdownUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_account_lockdown_stage_request = account_lockdown_stage_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<StagesAccountLockdownUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get a list of all objects that use this object
pub async fn stages_account_lockdown_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAccountLockdownUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/account_lockdown/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<StagesAccountLockdownUsedByListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn stages_all_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAllDestroyError>> {
    ...
    let uri_str = format!("{}/stages/all/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_all_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::Stage, Error<StagesAllRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Stage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Stage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_all_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAllUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/all/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_duo_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAuthenticatorDuoDestroyError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/duo/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_authenticator_duo_enrollment_status_create(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::DuoDeviceEnrollmentStatus, Error<StagesAuthenticatorDuoEnrollmentStatusCreateError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/duo/{stage_uuid}/enrollment_status/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn stages_authenticator_duo_import_device_manual_create(configuration: &configuration::Configuration, stage_uuid: &str, authenticator_duo_stage_manual_device_import_request: models::AuthenticatorDuoStageManualDeviceImportRequest) -> Result<(), Error<StagesAuthenticatorDuoImportDeviceManualCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_authenticator_duo_stage_manual_device_import_request = authenticator_duo_stage_manual_device_import_request;

    let uri_str = format!("{}/stages/authenticator/duo/{stage_uuid}/import_device_manual/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn stages_authenticator_duo_import_devices_automatic_create(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::AuthenticatorDuoStageDeviceImportResponse, Error<StagesAuthenticatorDuoImportDevicesAutomaticCreateError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/duo/{stage_uuid}/import_devices_automatic/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<StagesAuthenticatorDuoImportDevicesAutomaticCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn stages_authenticator_duo_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAuthenticatorDuoUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/duo/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_email_create(configuration: &configuration::Configuration, authenticator_email_stage_request: models::AuthenticatorEmailStageRequest) -> Result<models::AuthenticatorEmailStage, Error<StagesAuthenticatorEmailCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// AuthenticatorEmailStage Viewset
pub async fn stages_authenticator_email_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAuthenticatorEmailDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/authenticator/email/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// AuthenticatorEmailStage Viewset
pub async fn stages_authenticator_email_list(configuration: &configuration::Configuration, configure_flow: Option<&str>, friendly_name: Option<&str>, from_address: Option<&str>, host: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, password: Option<&str>, port: Option<i32>, search: Option<&str>, stage_uuid: Option<&str>, subject: Option<&str>, template: Option<&str>, timeout: Option<i32>, token_expiry: Option<&str>, use_global_settings: Option<bool>, use_ssl: Option<bool>, use_tls: Option<bool>, username: Option<&str>) -> Result<models::PaginatedAuthenticatorEmailStageList, Error<StagesAuthenticatorEmailListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_configure_flow = configure_flow;
...
/// AuthenticatorEmailStage Viewset
pub async fn stages_authenticator_email_partial_update(configuration: &configuration::Configuration, stage_uuid: &str, patched_authenticator_email_stage_request: Option<models::PatchedAuthenticatorEmailStageRequest>) -> Result<models::AuthenticatorEmailStage, Error<StagesAuthenticatorEmailPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// AuthenticatorEmailStage Viewset
pub async fn stages_authenticator_email_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::AuthenticatorEmailStage, Error<StagesAuthenticatorEmailRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// AuthenticatorEmailStage Viewset
pub async fn stages_authenticator_email_update(configuration: &configuration::Configuration, stage_uuid: &str, authenticator_email_stage_request: models::AuthenticatorEmailStageRequest) -> Result<models::AuthenticatorEmailStage, Error<StagesAuthenticatorEmailUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_authenticator_email_stage_request = authenticator_email_stage_request;
...
/// Get a list of all objects that use this object
pub async fn stages_authenticator_email_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAuthenticatorEmailUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/authenticator/email/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_endpoint_gdtc_create(configuration: &configuration::Configuration, authenticator_endpoint_gdtc_stage_request: models::AuthenticatorEndpointGdtcStageRequest) -> Result<models::AuthenticatorEndpointGdtcStage, Error<StagesAuthenticatorEndpointGdtcCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// AuthenticatorEndpointGDTCStage Viewset
pub async fn stages_authenticator_endpoint_gdtc_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAuthenticatorEndpointGdtcDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/authenticator/endpoint_gdtc/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// AuthenticatorEndpointGDTCStage Viewset
pub async fn stages_authenticator_endpoint_gdtc_list(configuration: &configuration::Configuration, configure_flow: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedAuthenticatorEndpointGdtcStageList, Error<StagesAuthenticatorEndpointGdtcListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_configure_flow = configure_flow;
    let p_query_name = name;
    let p_query_ordering = ordering;
...
/// AuthenticatorEndpointGDTCStage Viewset
pub async fn stages_authenticator_endpoint_gdtc_partial_update(configuration: &configuration::Configuration, stage_uuid: &str, patched_authenticator_endpoint_gdtc_stage_request: Option<models::PatchedAuthenticatorEndpointGdtcStageRequest>) -> Result<models::AuthenticatorEndpointGdtcStage, Error<StagesAuthenticatorEndpointGdtcPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// AuthenticatorEndpointGDTCStage Viewset
pub async fn stages_authenticator_endpoint_gdtc_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::AuthenticatorEndpointGdtcStage, Error<StagesAuthenticatorEndpointGdtcRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// AuthenticatorEndpointGDTCStage Viewset
pub async fn stages_authenticator_endpoint_gdtc_update(configuration: &configuration::Configuration, stage_uuid: &str, authenticator_endpoint_gdtc_stage_request: models::AuthenticatorEndpointGdtcStageRequest) -> Result<models::AuthenticatorEndpointGdtcStage, Error<StagesAuthenticatorEndpointGdtcUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_authenticator_endpoint_gdtc_stage_request = authenticator_endpoint_gdtc_stage_request;
...
/// Get a list of all objects that use this object
pub async fn stages_authenticator_endpoint_gdtc_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAuthenticatorEndpointGdtcUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/authenticator/endpoint_gdtc/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_sms_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAuthenticatorSmsDestroyError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/sms/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// AuthenticatorSMSStage Viewset
pub async fn stages_authenticator_sms_list(configuration: &configuration::Configuration, account_sid: Option<&str>, auth: Option<&str>, auth_password: Option<&str>, auth_type: Option<models::AuthTypeEnum>, configure_flow: Option<&str>, friendly_name: Option<&str>, from_number: Option<&str>, mapping: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, provider: Option<models::ProviderEnum>, search: Option<&str>, stage_uuid: Option<&str>, verify_only: Option<bool>) -> Result<models::PaginatedAuthenticatorSmsStageList, Error<StagesAuthenticatorSmsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn stages_authenticator_sms_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAuthenticatorSmsUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/sms/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_static_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAuthenticatorStaticDestroyError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/static/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_authenticator_static_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAuthenticatorStaticUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/static/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_totp_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAuthenticatorTotpDestroyError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/totp/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// AuthenticatorTOTPStage Viewset
pub async fn stages_authenticator_totp_list(configuration: &configuration::Configuration, configure_flow: Option<&str>, digits: Option<models::DigitsEnum>, friendly_name: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, stage_uuid: Option<&str>) -> Result<models::PaginatedAuthenticatorTotpStageList, Error<StagesAuthenticatorTotpListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_configure_flow = configure_flow;
...
pub async fn stages_authenticator_totp_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAuthenticatorTotpUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/totp/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_validate_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAuthenticatorValidateDestroyError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/validate/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// AuthenticatorValidateStage Viewset
pub async fn stages_authenticator_validate_list(configuration: &configuration::Configuration, configuration_stages: Option<Vec<uuid::Uuid>>, name: Option<&str>, not_configured_action: Option<models::NotConfiguredActionEnum>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedAuthenticatorValidateStageList, Error<StagesAuthenticatorValidateListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_configuration_stages {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("configuration_stages".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("configuration_stages", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_name {
        req_builder = req_builder.query(&[("name", &param_value.to_string())]);
...
pub async fn stages_authenticator_validate_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAuthenticatorValidateUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/validate/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_webauthn_create(configuration: &configuration::Configuration, authenticator_web_authn_stage_request: models::AuthenticatorWebAuthnStageRequest) -> Result<models::AuthenticatorWebAuthnStage, Error<StagesAuthenticatorWebauthnCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn stages_authenticator_webauthn_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesAuthenticatorWebauthnDestroyError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/webauthn/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_authenticator_webauthn_device_types_list(configuration: &configuration::Configuration, aaguid: Option<&str>, description: Option<&str>, icon: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedWebAuthnDeviceTypeList, Error<StagesAuthenticatorWebauthnDeviceTypesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/stages/authenticator/webauthn_device_types/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// WebAuthnDeviceType Viewset
pub async fn stages_authenticator_webauthn_device_types_retrieve(configuration: &configuration::Configuration, aaguid: &str) -> Result<models::WebAuthnDeviceType, Error<StagesAuthenticatorWebauthnDeviceTypesRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_aaguid = aaguid;

    let uri_str = format!("{}/stages/authenticator/webauthn_device_types/{aaguid}/", configuration.base_path, aaguid=crate::apis::urlencode(p_path_aaguid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// AuthenticatorWebAuthnStage Viewset
pub async fn stages_authenticator_webauthn_list(configuration: &configuration::Configuration, authenticator_attachment: Option<models::AuthenticatorAttachmentEnum>, configure_flow: Option<&str>, device_type_restrictions: Option<Vec<uuid::Uuid>>, max_attempts: Option<i32>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, resident_key_requirement: Option<models::UserVerificationEnum>, search: Option<&str>, user_verification: Option<models::UserVerificationEnum>) -> Result<models::PaginatedAuthenticatorWebAuthnStageList, Error<StagesAuthenticatorWebauthnListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_device_type_restrictions {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("device_type_restrictions".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("device_type_restrictions", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
/// AuthenticatorWebAuthnStage Viewset
pub async fn stages_authenticator_webauthn_partial_update(configuration: &configuration::Configuration, stage_uuid: &str, patched_authenticator_web_authn_stage_request: Option<models::PatchedAuthenticatorWebAuthnStageRequest>) -> Result<models::AuthenticatorWebAuthnStage, Error<StagesAuthenticatorWebauthnPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// AuthenticatorWebAuthnStage Viewset
pub async fn stages_authenticator_webauthn_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::AuthenticatorWebAuthnStage, Error<StagesAuthenticatorWebauthnRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// AuthenticatorWebAuthnStage Viewset
pub async fn stages_authenticator_webauthn_update(configuration: &configuration::Configuration, stage_uuid: &str, authenticator_web_authn_stage_request: models::AuthenticatorWebAuthnStageRequest) -> Result<models::AuthenticatorWebAuthnStage, Error<StagesAuthenticatorWebauthnUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_authenticator_web_authn_stage_request = authenticator_web_authn_stage_request;
...
pub async fn stages_authenticator_webauthn_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesAuthenticatorWebauthnUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/authenticator/webauthn/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_captcha_create(configuration: &configuration::Configuration, captcha_stage_request: models::CaptchaStageRequest) -> Result<models::CaptchaStage, Error<StagesCaptchaCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CaptchaStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CaptchaStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_captcha_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesCaptchaDestroyError>> {
    ...
    let uri_str = format!("{}/stages/captcha/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_captcha_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesCaptchaUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/captcha/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_consent_create(configuration: &configuration::Configuration, consent_stage_request: models::ConsentStageRequest) -> Result<models::ConsentStage, Error<StagesConsentCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ConsentStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ConsentStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_consent_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesConsentDestroyError>> {
    ...
    let uri_str = format!("{}/stages/consent/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_consent_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesConsentUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/consent/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_deny_create(configuration: &configuration::Configuration, deny_stage_request: models::DenyStageRequest) -> Result<models::DenyStage, Error<StagesDenyCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DenyStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DenyStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_deny_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesDenyDestroyError>> {
    ...
    let uri_str = format!("{}/stages/deny/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_deny_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesDenyUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/deny/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_dummy_create(configuration: &configuration::Configuration, dummy_stage_request: models::DummyStageRequest) -> Result<models::DummyStage, Error<StagesDummyCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DummyStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DummyStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_dummy_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesDummyDestroyError>> {
    ...
    let uri_str = format!("{}/stages/dummy/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_dummy_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesDummyUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/dummy/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_email_create(configuration: &configuration::Configuration, email_stage_request: models::EmailStageRequest) -> Result<models::EmailStage, Error<StagesEmailCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EmailStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EmailStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_email_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesEmailDestroyError>> {
    ...
    let uri_str = format!("{}/stages/email/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_email_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesEmailUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/email/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_endpoints_create(configuration: &configuration::Configuration, endpoint_stage_request: models::EndpointStageRequest) -> Result<models::EndpointStage, Error<StagesEndpointsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EndpointStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EndpointStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// EndpointStage Viewset
pub async fn stages_endpoints_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesEndpointsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/endpoints/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// EndpointStage Viewset
pub async fn stages_endpoints_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedEndpointStageList, Error<StagesEndpointsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginatedEndpointStageList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginatedEndpointStageList`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// EndpointStage Viewset
pub async fn stages_endpoints_partial_update(configuration: &configuration::Configuration, stage_uuid: &str, patched_endpoint_stage_request: Option<models::PatchedEndpointStageRequest>) -> Result<models::EndpointStage, Error<StagesEndpointsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// EndpointStage Viewset
pub async fn stages_endpoints_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::EndpointStage, Error<StagesEndpointsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// EndpointStage Viewset
pub async fn stages_endpoints_update(configuration: &configuration::Configuration, stage_uuid: &str, endpoint_stage_request: models::EndpointStageRequest) -> Result<models::EndpointStage, Error<StagesEndpointsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_endpoint_stage_request = endpoint_stage_request;
...
/// Get a list of all objects that use this object
pub async fn stages_endpoints_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesEndpointsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/endpoints/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_identification_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesIdentificationDestroyError>> {
    ...
    let uri_str = format!("{}/stages/identification/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// IdentificationStage Viewset
pub async fn stages_identification_list(configuration: &configuration::Configuration, captcha_stage: Option<&str>, case_insensitive_matching: Option<bool>, enrollment_flow: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, password_stage: Option<&str>, passwordless_flow: Option<&str>, recovery_flow: Option<&str>, search: Option<&str>, show_matched_user: Option<bool>, show_source_labels: Option<bool>, webauthn_stage: Option<&str>) -> Result<models::PaginatedIdentificationStageList, Error<StagesIdentificationListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn stages_identification_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesIdentificationUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/identification/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_invitation_invitations_destroy(configuration: &configuration::Configuration, invite_uuid: &str) -> Result<(), Error<StagesInvitationInvitationsDestroyError>> {
    ...
    let uri_str = format!("{}/stages/invitation/invitations/{invite_uuid}/", configuration.base_path, invite_uuid=crate::apis::urlencode(p_path_invite_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_invitation_invitations_send_email_create(configuration: &configuration::Configuration, invite_uuid: &str, invitation_send_email_request: models::InvitationSendEmailRequest) -> Result<(), Error<StagesInvitationInvitationsSendEmailCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_invite_uuid = invite_uuid;
    let p_body_invitation_send_email_request = invitation_send_email_request;

    let uri_str = format!("{}/stages/invitation/invitations/{invite_uuid}/send_email/", configuration.base_path, invite_uuid=crate::apis::urlencode(p_path_invite_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn stages_invitation_invitations_used_by_list(configuration: &configuration::Configuration, invite_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesInvitationInvitationsUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/invitation/invitations/{invite_uuid}/used_by/", configuration.base_path, invite_uuid=crate::apis::urlencode(p_path_invite_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_invitation_stages_create(configuration: &configuration::Configuration, invitation_stage_request: models::InvitationStageRequest) -> Result<models::InvitationStage, Error<StagesInvitationStagesCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::InvitationStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::InvitationStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_invitation_stages_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesInvitationStagesDestroyError>> {
    ...
    let uri_str = format!("{}/stages/invitation/stages/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_invitation_stages_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesInvitationStagesUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/invitation/stages/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_mtls_create(configuration: &configuration::Configuration, mutual_tls_stage_request: models::MutualTlsStageRequest) -> Result<models::MutualTlsStage, Error<StagesMtlsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::MutualTlsStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::MutualTlsStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// MutualTLSStage Viewset
pub async fn stages_mtls_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesMtlsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/mtls/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// MutualTLSStage Viewset
pub async fn stages_mtls_list(configuration: &configuration::Configuration, cert_attribute: Option<models::CertAttributeEnum>, certificate_authorities: Option<Vec<uuid::Uuid>>, mode: Option<models::StageModeEnum>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, stage_uuid: Option<&str>, user_attribute: Option<models::UserAttributeEnum>) -> Result<models::PaginatedMutualTlsStageList, Error<StagesMtlsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_certificate_authorities {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("certificate_authorities".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("certificate_authorities", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_mode {
        req_builder = req_builder.query(&[("mode", &param_value.to_string())]);
...
/// MutualTLSStage Viewset
pub async fn stages_mtls_partial_update(configuration: &configuration::Configuration, stage_uuid: &str, patched_mutual_tls_stage_request: Option<models::PatchedMutualTlsStageRequest>) -> Result<models::MutualTlsStage, Error<StagesMtlsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// MutualTLSStage Viewset
pub async fn stages_mtls_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::MutualTlsStage, Error<StagesMtlsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// MutualTLSStage Viewset
pub async fn stages_mtls_update(configuration: &configuration::Configuration, stage_uuid: &str, mutual_tls_stage_request: models::MutualTlsStageRequest) -> Result<models::MutualTlsStage, Error<StagesMtlsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_mutual_tls_stage_request = mutual_tls_stage_request;
...
/// Get a list of all objects that use this object
pub async fn stages_mtls_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesMtlsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/mtls/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_password_create(configuration: &configuration::Configuration, password_stage_request: models::PasswordStageRequest) -> Result<models::PasswordStage, Error<StagesPasswordCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PasswordStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PasswordStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_password_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesPasswordDestroyError>> {
    ...
    let uri_str = format!("{}/stages/password/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_password_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesPasswordUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/password/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_prompt_prompts_destroy(configuration: &configuration::Configuration, prompt_uuid: &str) -> Result<(), Error<StagesPromptPromptsDestroyError>> {
    ...
    let uri_str = format!("{}/stages/prompt/prompts/{prompt_uuid}/", configuration.base_path, prompt_uuid=crate::apis::urlencode(p_path_prompt_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_prompt_prompts_preview_create(configuration: &configuration::Configuration, prompt_request: models::PromptRequest) -> Result<models::PromptChallenge, Error<StagesPromptPromptsPreviewCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PromptChallenge`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PromptChallenge`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_prompt_prompts_used_by_list(configuration: &configuration::Configuration, prompt_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesPromptPromptsUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/prompt/prompts/{prompt_uuid}/used_by/", configuration.base_path, prompt_uuid=crate::apis::urlencode(p_path_prompt_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_prompt_stages_create(configuration: &configuration::Configuration, prompt_stage_request: models::PromptStageRequest) -> Result<models::PromptStage, Error<StagesPromptStagesCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PromptStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PromptStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_prompt_stages_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesPromptStagesDestroyError>> {
    ...
    let uri_str = format!("{}/stages/prompt/stages/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_prompt_stages_list(configuration: &configuration::Configuration, fields: Option<Vec<uuid::Uuid>>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, stage_uuid: Option<&str>, validation_policies: Option<Vec<uuid::Uuid>>) -> Result<models::PaginatedPromptStageList, Error<StagesPromptStagesListError>> {
    ...
    if let Some(ref param_value) = p_query_validation_policies {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("validation_policies".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("validation_policies", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
...
pub async fn stages_prompt_stages_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesPromptStagesUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/prompt/stages/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_redirect_create(configuration: &configuration::Configuration, redirect_stage_request: models::RedirectStageRequest) -> Result<models::RedirectStage, Error<StagesRedirectCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RedirectStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RedirectStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// RedirectStage Viewset
pub async fn stages_redirect_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesRedirectDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/redirect/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// RedirectStage Viewset
pub async fn stages_redirect_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedRedirectStageList, Error<StagesRedirectListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// RedirectStage Viewset
pub async fn stages_redirect_partial_update(configuration: &configuration::Configuration, stage_uuid: &str, patched_redirect_stage_request: Option<models::PatchedRedirectStageRequest>) -> Result<models::RedirectStage, Error<StagesRedirectPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// RedirectStage Viewset
pub async fn stages_redirect_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::RedirectStage, Error<StagesRedirectRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// RedirectStage Viewset
pub async fn stages_redirect_update(configuration: &configuration::Configuration, stage_uuid: &str, redirect_stage_request: models::RedirectStageRequest) -> Result<models::RedirectStage, Error<StagesRedirectUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_redirect_stage_request = redirect_stage_request;
...
/// Get a list of all objects that use this object
pub async fn stages_redirect_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesRedirectUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/redirect/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// SourceStage Viewset
pub async fn stages_source_create(configuration: &configuration::Configuration, source_stage_request: models::SourceStageRequest) -> Result<models::SourceStage, Error<StagesSourceCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SourceStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SourceStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// SourceStage Viewset
pub async fn stages_source_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesSourceDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/source/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SourceStage Viewset
pub async fn stages_source_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, resume_timeout: Option<&str>, search: Option<&str>, source: Option<&str>, stage_uuid: Option<&str>) -> Result<models::PaginatedSourceStageList, Error<StagesSourceListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// SourceStage Viewset
pub async fn stages_source_partial_update(configuration: &configuration::Configuration, stage_uuid: &str, patched_source_stage_request: Option<models::PatchedSourceStageRequest>) -> Result<models::SourceStage, Error<StagesSourcePartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// SourceStage Viewset
pub async fn stages_source_retrieve(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<models::SourceStage, Error<StagesSourceRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
...
/// SourceStage Viewset
pub async fn stages_source_update(configuration: &configuration::Configuration, stage_uuid: &str, source_stage_request: models::SourceStageRequest) -> Result<models::SourceStage, Error<StagesSourceUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;
    let p_body_source_stage_request = source_stage_request;
...
/// Get a list of all objects that use this object
pub async fn stages_source_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesSourceUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_stage_uuid = stage_uuid;

    let uri_str = format!("{}/stages/source/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_user_delete_create(configuration: &configuration::Configuration, user_delete_stage_request: models::UserDeleteStageRequest) -> Result<models::UserDeleteStage, Error<StagesUserDeleteCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserDeleteStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserDeleteStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_user_delete_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesUserDeleteDestroyError>> {
    ...
    let uri_str = format!("{}/stages/user_delete/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_user_delete_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesUserDeleteUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/user_delete/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_user_login_create(configuration: &configuration::Configuration, user_login_stage_request: models::UserLoginStageRequest) -> Result<models::UserLoginStage, Error<StagesUserLoginCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserLoginStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserLoginStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_user_login_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesUserLoginDestroyError>> {
    ...
    let uri_str = format!("{}/stages/user_login/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// UserLoginStage Viewset
pub async fn stages_user_login_list(configuration: &configuration::Configuration, geoip_binding: Option<models::GeoipBindingEnum>, name: Option<&str>, network_binding: Option<models::NetworkBindingEnum>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, remember_device: Option<&str>, remember_me_offset: Option<&str>, search: Option<&str>, session_duration: Option<&str>, stage_uuid: Option<&str>, terminate_other_sessions: Option<bool>) -> Result<models::PaginatedUserLoginStageList, Error<StagesUserLoginListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn stages_user_login_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesUserLoginUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/user_login/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_user_logout_create(configuration: &configuration::Configuration, user_logout_stage_request: models::UserLogoutStageRequest) -> Result<models::UserLogoutStage, Error<StagesUserLogoutCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserLogoutStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserLogoutStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_user_logout_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesUserLogoutDestroyError>> {
    ...
    let uri_str = format!("{}/stages/user_logout/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_user_logout_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesUserLogoutUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/user_logout/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_user_write_create(configuration: &configuration::Configuration, user_write_stage_request: models::UserWriteStageRequest) -> Result<models::UserWriteStage, Error<StagesUserWriteCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserWriteStage`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserWriteStage`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn stages_user_write_destroy(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<(), Error<StagesUserWriteDestroyError>> {
    ...
    let uri_str = format!("{}/stages/user_write/{stage_uuid}/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_user_write_used_by_list(configuration: &configuration::Configuration, stage_uuid: &str) -> Result<Vec<models::UsedBy>, Error<StagesUserWriteUsedByListError>> {
    ...
    let uri_str = format!("{}/stages/user_write/{stage_uuid}/used_by/", configuration.base_path, stage_uuid=crate::apis::urlencode(p_path_stage_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
