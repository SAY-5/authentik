...
pub async fn policies_all_cache_info_retrieve(configuration: &configuration::Configuration, ) -> Result<models::Cache, Error<PoliciesAllCacheInfoRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Cache`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Cache`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn policies_all_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesAllDestroyError>> {
    ...
    let uri_str = format!("{}/policies/all/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
...
pub async fn policies_all_test_create(configuration: &configuration::Configuration, policy_uuid: &str, policy_test_request: models::PolicyTestRequest) -> Result<models::PolicyTestResult, Error<PoliciesAllTestCreateError>> {
    ...
    let uri_str = format!("{}/policies/all/{policy_uuid}/test/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn policies_all_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesAllUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/all/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_bindings_create(configuration: &configuration::Configuration, policy_binding_request: models::PolicyBindingRequest) -> Result<models::PolicyBinding, Error<PoliciesBindingsCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PolicyBinding`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PolicyBinding`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn policies_bindings_destroy(configuration: &configuration::Configuration, policy_binding_uuid: &str) -> Result<(), Error<PoliciesBindingsDestroyError>> {
    ...
    let uri_str = format!("{}/policies/bindings/{policy_binding_uuid}/", configuration.base_path, policy_binding_uuid=crate::apis::urlencode(p_path_policy_binding_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_bindings_list(configuration: &configuration::Configuration, enabled: Option<bool>, order: Option<i32>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, policy: Option<&str>, policy__isnull: Option<bool>, search: Option<&str>, target: Option<&str>, target_in: Option<Vec<uuid::Uuid>>, timeout: Option<i32>) -> Result<models::PaginatedPolicyBindingList, Error<PoliciesBindingsListError>> {
    ...
    if let Some(ref param_value) = p_query_target_in {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("target_in".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("target_in", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn policies_bindings_used_by_list(configuration: &configuration::Configuration, policy_binding_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesBindingsUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/bindings/{policy_binding_uuid}/used_by/", configuration.base_path, policy_binding_uuid=crate::apis::urlencode(p_path_policy_binding_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_dummy_create(configuration: &configuration::Configuration, dummy_policy_request: models::DummyPolicyRequest) -> Result<models::DummyPolicy, Error<PoliciesDummyCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DummyPolicy`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DummyPolicy`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn policies_dummy_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesDummyDestroyError>> {
    ...
    let uri_str = format!("{}/policies/dummy/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_dummy_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesDummyUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/dummy/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_event_matcher_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesEventMatcherDestroyError>> {
    ...
    let uri_str = format!("{}/policies/event_matcher/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_event_matcher_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesEventMatcherUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/event_matcher/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_expression_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesExpressionDestroyError>> {
    ...
    let uri_str = format!("{}/policies/expression/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_expression_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesExpressionUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/expression/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// GeoIP Viewset
pub async fn policies_geoip_create(configuration: &configuration::Configuration, geo_ip_policy_request: models::GeoIpPolicyRequest) -> Result<models::GeoIpPolicy, Error<PoliciesGeoipCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GeoIpPolicy`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GeoIpPolicy`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// GeoIP Viewset
pub async fn policies_geoip_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesGeoipDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;

    let uri_str = format!("{}/policies/geoip/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_geoip_iso3166_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::DetailedCountry>, Error<PoliciesGeoipIso3166ListError>> {
...
/// GeoIP Viewset
pub async fn policies_geoip_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedGeoIpPolicyList, Error<PoliciesGeoipListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// GeoIP Viewset
pub async fn policies_geoip_partial_update(configuration: &configuration::Configuration, policy_uuid: &str, patched_geo_ip_policy_request: Option<models::PatchedGeoIpPolicyRequest>) -> Result<models::GeoIpPolicy, Error<PoliciesGeoipPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;
...
/// GeoIP Viewset
pub async fn policies_geoip_retrieve(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<models::GeoIpPolicy, Error<PoliciesGeoipRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;
...
/// GeoIP Viewset
pub async fn policies_geoip_update(configuration: &configuration::Configuration, policy_uuid: &str, geo_ip_policy_request: models::GeoIpPolicyRequest) -> Result<models::GeoIpPolicy, Error<PoliciesGeoipUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;
    let p_body_geo_ip_policy_request = geo_ip_policy_request;
...
/// Get a list of all objects that use this object
pub async fn policies_geoip_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesGeoipUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;

    let uri_str = format!("{}/policies/geoip/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_password_create(configuration: &configuration::Configuration, password_policy_request: models::PasswordPolicyRequest) -> Result<models::PasswordPolicy, Error<PoliciesPasswordCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PasswordPolicy`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PasswordPolicy`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn policies_password_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesPasswordDestroyError>> {
    ...
    let uri_str = format!("{}/policies/password/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_password_expiry_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesPasswordExpiryDestroyError>> {
    ...
    let uri_str = format!("{}/policies/password_expiry/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_password_expiry_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesPasswordExpiryUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/password_expiry/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_password_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesPasswordUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/password/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_reputation_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesReputationDestroyError>> {
    ...
    let uri_str = format!("{}/policies/reputation/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_reputation_scores_destroy(configuration: &configuration::Configuration, reputation_uuid: &str) -> Result<(), Error<PoliciesReputationScoresDestroyError>> {
    ...
    let uri_str = format!("{}/policies/reputation/scores/{reputation_uuid}/", configuration.base_path, reputation_uuid=crate::apis::urlencode(p_path_reputation_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Reputation Viewset
pub async fn policies_reputation_scores_list(configuration: &configuration::Configuration, identifier: Option<&str>, identifier_in: Option<Vec<String>>, ip: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, score: Option<i32>, search: Option<&str>) -> Result<models::PaginatedReputationList, Error<PoliciesReputationScoresListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_identifier_in {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("identifier_in".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("identifier_in", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn policies_reputation_scores_retrieve(configuration: &configuration::Configuration, reputation_uuid: &str) -> Result<models::Reputation, Error<PoliciesReputationScoresRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Reputation`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Reputation`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn policies_reputation_scores_used_by_list(configuration: &configuration::Configuration, reputation_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesReputationScoresUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/reputation/scores/{reputation_uuid}/used_by/", configuration.base_path, reputation_uuid=crate::apis::urlencode(p_path_reputation_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_reputation_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesReputationUsedByListError>> {
    ...
    let uri_str = format!("{}/policies/reputation/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn policies_unique_password_create(configuration: &configuration::Configuration, unique_password_policy_request: models::UniquePasswordPolicyRequest) -> Result<models::UniquePasswordPolicy, Error<PoliciesUniquePasswordCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Password Uniqueness Policy Viewset
pub async fn policies_unique_password_destroy(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<(), Error<PoliciesUniquePasswordDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;

    let uri_str = format!("{}/policies/unique_password/{policy_uuid}/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Password Uniqueness Policy Viewset
pub async fn policies_unique_password_list(configuration: &configuration::Configuration, created: Option<String>, execution_logging: Option<bool>, last_updated: Option<String>, name: Option<&str>, num_historical_passwords: Option<i32>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, password_field: Option<&str>, policy_uuid: Option<&str>, search: Option<&str>) -> Result<models::PaginatedUniquePasswordPolicyList, Error<PoliciesUniquePasswordListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_created = created;
    let p_query_execution_logging = execution_logging;
    let p_query_last_updated = last_updated;
...
/// Password Uniqueness Policy Viewset
pub async fn policies_unique_password_partial_update(configuration: &configuration::Configuration, policy_uuid: &str, patched_unique_password_policy_request: Option<models::PatchedUniquePasswordPolicyRequest>) -> Result<models::UniquePasswordPolicy, Error<PoliciesUniquePasswordPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;
...
/// Password Uniqueness Policy Viewset
pub async fn policies_unique_password_retrieve(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<models::UniquePasswordPolicy, Error<PoliciesUniquePasswordRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;
...
/// Password Uniqueness Policy Viewset
pub async fn policies_unique_password_update(configuration: &configuration::Configuration, policy_uuid: &str, unique_password_policy_request: models::UniquePasswordPolicyRequest) -> Result<models::UniquePasswordPolicy, Error<PoliciesUniquePasswordUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;
    let p_body_unique_password_policy_request = unique_password_policy_request;
...
/// Get a list of all objects that use this object
pub async fn policies_unique_password_used_by_list(configuration: &configuration::Configuration, policy_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PoliciesUniquePasswordUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_uuid = policy_uuid;

    let uri_str = format!("{}/policies/unique_password/{policy_uuid}/used_by/", configuration.base_path, policy_uuid=crate::apis::urlencode(p_path_policy_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
