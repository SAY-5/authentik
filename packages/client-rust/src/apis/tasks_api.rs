...
pub async fn tasks_schedules_list(configuration: &configuration::Configuration, actor_name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, paused: Option<bool>, rel_obj_content_type__app_label: Option<&str>, rel_obj_content_type__model: Option<&str>, rel_obj_id: Option<&str>, rel_obj_id__isnull: Option<bool>, search: Option<&str>) -> Result<models::PaginatedScheduleList, Error<TasksSchedulesListError>> {
...
pub async fn tasks_schedules_partial_update(configuration: &configuration::Configuration, id: &str, patched_schedule_request: Option<models::PatchedScheduleRequest>) -> Result<models::Schedule, Error<TasksSchedulesPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_patched_schedule_request = patched_schedule_request;

    let uri_str = format!("{}/tasks/schedules/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Schedule`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Schedule`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn tasks_schedules_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::Schedule, Error<TasksSchedulesRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn tasks_schedules_send_create(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<TasksSchedulesSendCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/tasks/schedules/{id}/send/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
...
pub async fn tasks_schedules_update(configuration: &configuration::Configuration, id: &str, schedule_request: models::ScheduleRequest) -> Result<models::Schedule, Error<TasksSchedulesUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn tasks_tasks_list(configuration: &configuration::Configuration, actor_name: Option<&str>, aggregated_status: Option<Vec<models::TaskAggregatedStatusEnum>>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, queue_name: Option<&str>, rel_obj_content_type__app_label: Option<&str>, rel_obj_content_type__model: Option<&str>, rel_obj_id: Option<&str>, rel_obj_id__isnull: Option<bool>, search: Option<&str>, state: Option<models::TaskStatusEnum>) -> Result<models::PaginatedTaskList, Error<TasksTasksListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_actor_name = actor_name;
    ...
    if let Some(ref param_value) = p_query_aggregated_status {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("aggregated_status".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("aggregated_status", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_ordering {
        req_builder = req_builder.query(&[("ordering", &param_value.to_string())]);
...
pub async fn tasks_tasks_retrieve(configuration: &configuration::Configuration, message_id: &str) -> Result<models::Task, Error<TasksTasksRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_message_id = message_id;

    let uri_str = format!("{}/tasks/tasks/{message_id}/", configuration.base_path, message_id=crate::apis::urlencode(p_path_message_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Retry task
pub async fn tasks_tasks_retry_create(configuration: &configuration::Configuration, message_id: &str) -> Result<(), Error<TasksTasksRetryCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_message_id = message_id;

    let uri_str = format!("{}/tasks/tasks/{message_id}/retry/", configuration.base_path, message_id=crate::apis::urlencode(p_path_message_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn tasks_tasks_status_retrieve(configuration: &configuration::Configuration, ) -> Result<models::GlobalTaskStatus, Error<TasksTasksStatusRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GlobalTaskStatus`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GlobalTaskStatus`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn tasks_workers_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::Worker>, Error<TasksWorkersListError>> {
