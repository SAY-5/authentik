...
pub async fn flows_bindings_destroy(configuration: &configuration::Configuration, fsb_uuid: &str) -> Result<(), Error<FlowsBindingsDestroyError>> {
    ...
    let uri_str = format!("{}/flows/bindings/{fsb_uuid}/", configuration.base_path, fsb_uuid=crate::apis::urlencode(p_path_fsb_uuid));
...
pub async fn flows_bindings_list(configuration: &configuration::Configuration, evaluate_on_plan: Option<bool>, fsb_uuid: Option<&str>, invalid_response_action: Option<models::InvalidResponseActionEnum>, order: Option<i32>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, policies: Option<Vec<uuid::Uuid>>, policy_engine_mode: Option<models::PolicyEngineMode>, re_evaluate_policies: Option<bool>, search: Option<&str>, stage: Option<&str>, target: Option<&str>) -> Result<models::PaginatedFlowStageBindingList, Error<FlowsBindingsListError>> {
    ...
    if let Some(ref param_value) = p_query_policies {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("policies".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("policies", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn flows_bindings_used_by_list(configuration: &configuration::Configuration, fsb_uuid: &str) -> Result<Vec<models::UsedBy>, Error<FlowsBindingsUsedByListError>> {
    ...
    let uri_str = format!("{}/flows/bindings/{fsb_uuid}/used_by/", configuration.base_path, fsb_uuid=crate::apis::urlencode(p_path_fsb_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn flows_executor_get(configuration: &configuration::Configuration, flow_slug: &str, query: &str) -> Result<models::ChallengeTypes, Error<FlowsExecutorGetError>> {
    ...
    let uri_str = format!("{}/flows/executor/{flow_slug}/", configuration.base_path, flow_slug=crate::apis::urlencode(p_path_flow_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ChallengeTypes`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ChallengeTypes`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn flows_inspector_get(configuration: &configuration::Configuration, flow_slug: &str) -> Result<models::FlowInspection, Error<FlowsInspectorGetError>> {
    ...
    let uri_str = format!("{}/flows/inspector/{flow_slug}/", configuration.base_path, flow_slug=crate::apis::urlencode(p_path_flow_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::FlowInspection`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::FlowInspection`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn flows_instances_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<FlowsInstancesDestroyError>> {
    ...
    let uri_str = format!("{}/flows/instances/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn flows_instances_diagram_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::FlowDiagram, Error<FlowsInstancesDiagramRetrieveError>> {
    ...
    let uri_str = format!("{}/flows/instances/{slug}/diagram/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::FlowDiagram`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::FlowDiagram`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn flows_instances_execute_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<models::Link, Error<FlowsInstancesExecuteRetrieveError>> {
    ...
    let uri_str = format!("{}/flows/instances/{slug}/execute/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn flows_instances_export_retrieve(configuration: &configuration::Configuration, slug: &str) -> Result<reqwest::Response, Error<FlowsInstancesExportRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/flows/instances/{slug}/export/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Flow Viewset
pub async fn flows_instances_list(configuration: &configuration::Configuration, denied_action: Option<models::DeniedActionEnum>, designation: Option<models::FlowDesignationEnum>, flow_uuid: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, slug: Option<&str>) -> Result<models::PaginatedFlowList, Error<FlowsInstancesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn flows_instances_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<FlowsInstancesUsedByListError>> {
    ...
    let uri_str = format!("{}/flows/instances/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
