...
pub async fn admin_file_create(configuration: &configuration::Configuration, file: std::path::PathBuf, name: Option<&str>, usage: Option<&str>) -> Result<(), Error<AdminFileCreateError>> {
...
pub async fn admin_file_destroy(configuration: &configuration::Configuration, name: Option<&str>, usage: Option<models::UsageEnum>) -> Result<(), Error<AdminFileDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn admin_file_list(configuration: &configuration::Configuration, manageable_only: Option<bool>, search: Option<&str>, usage: Option<models::UsageEnum>) -> Result<Vec<models::FileList>, Error<AdminFileListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::FileList&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::FileList&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn admin_file_used_by_list(configuration: &configuration::Configuration, name: Option<&str>) -> Result<Vec<models::UsedBy>, Error<AdminFileUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
...
pub async fn admin_settings_partial_update(configuration: &configuration::Configuration, patched_settings_request: Option<models::PatchedSettingsRequest>) -> Result<models::Settings, Error<AdminSettingsPartialUpdateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Settings`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Settings`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Settings view
pub async fn admin_settings_update(configuration: &configuration::Configuration, settings_request: models::SettingsRequest) -> Result<models::Settings, Error<AdminSettingsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn admin_version_history_list(configuration: &configuration::Configuration, build: Option<&str>, ordering: Option<&str>, search: Option<&str>, version: Option<&str>) -> Result<Vec<models::VersionHistory>, Error<AdminVersionHistoryListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// VersionHistory Viewset
pub async fn admin_version_history_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::VersionHistory, Error<AdminVersionHistoryRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/admin/version/history/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VersionHistory`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VersionHistory`")))),
        }
    } else {
        let content = resp.text().await?;
