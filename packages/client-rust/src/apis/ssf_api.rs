...
/// SSFStream Viewset
pub async fn ssf_streams_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<SsfStreamsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/ssf/streams/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
...
/// SSFStream Viewset
pub async fn ssf_streams_list(configuration: &configuration::Configuration, delivery_method: Option<models::DeliveryMethodEnum>, endpoint_url: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, provider: Option<i32>, search: Option<&str>) -> Result<models::PaginatedSsfStreamList, Error<SsfStreamsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SSFStream Viewset
pub async fn ssf_streams_retrieve(configuration: &configuration::Configuration, uuid: &str) -> Result<models::SsfStream, Error<SsfStreamsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
