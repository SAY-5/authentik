...
/// Provider Viewset
pub async fn providers_all_list(configuration: &configuration::Configuration, application__isnull: Option<bool>, backchannel: Option<bool>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedProviderList, Error<ProvidersAllListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn providers_all_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::Provider, Error<ProvidersAllRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Provider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Provider`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn providers_all_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersAllUsedByListError>> {
    ...
    let uri_str = format!("{}/providers/all/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_google_workspace_create(configuration: &configuration::Configuration, google_workspace_provider_request: models::GoogleWorkspaceProviderRequest) -> Result<models::GoogleWorkspaceProvider, Error<ProvidersGoogleWorkspaceCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// GoogleWorkspaceProvider Viewset
pub async fn providers_google_workspace_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<ProvidersGoogleWorkspaceDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/google_workspace/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_google_workspace_groups_create(configuration: &configuration::Configuration, google_workspace_provider_group_request: models::GoogleWorkspaceProviderGroupRequest) -> Result<models::GoogleWorkspaceProviderGroup, Error<ProvidersGoogleWorkspaceGroupsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// GoogleWorkspaceProviderGroup Viewset
pub async fn providers_google_workspace_groups_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<ProvidersGoogleWorkspaceGroupsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/google_workspace_groups/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// GoogleWorkspaceProviderGroup Viewset
pub async fn providers_google_workspace_groups_list(configuration: &configuration::Configuration, group__group_uuid: Option<&str>, group__name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, provider__id: Option<i32>, search: Option<&str>) -> Result<models::PaginatedGoogleWorkspaceProviderGroupList, Error<ProvidersGoogleWorkspaceGroupsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// GoogleWorkspaceProviderGroup Viewset
pub async fn providers_google_workspace_groups_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::GoogleWorkspaceProviderGroup, Error<ProvidersGoogleWorkspaceGroupsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Get a list of all objects that use this object
pub async fn providers_google_workspace_groups_used_by_list(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::UsedBy>, Error<ProvidersGoogleWorkspaceGroupsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/google_workspace_groups/{id}/used_by/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// GoogleWorkspaceProvider Viewset
pub async fn providers_google_workspace_list(configuration: &configuration::Configuration, delegated_subject: Option<&str>, exclude_users_service_account: Option<bool>, filter_group: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedGoogleWorkspaceProviderList, Error<ProvidersGoogleWorkspaceListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// GoogleWorkspaceProvider Viewset
pub async fn providers_google_workspace_partial_update(configuration: &configuration::Configuration, id: i32, patched_google_workspace_provider_request: Option<models::PatchedGoogleWorkspaceProviderRequest>) -> Result<models::GoogleWorkspaceProvider, Error<ProvidersGoogleWorkspacePartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// GoogleWorkspaceProvider Viewset
pub async fn providers_google_workspace_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::GoogleWorkspaceProvider, Error<ProvidersGoogleWorkspaceRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn providers_google_workspace_sync_object_create(configuration: &configuration::Configuration, id: i32, sync_object_request: models::SyncObjectRequest) -> Result<models::SyncObjectResult, Error<ProvidersGoogleWorkspaceSyncObjectCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_sync_object_request = sync_object_request;

    let uri_str = format!("{}/providers/google_workspace/{id}/sync/object/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn providers_google_workspace_sync_status_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::SyncStatus, Error<ProvidersGoogleWorkspaceSyncStatusRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/google_workspace/{id}/sync/status/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// GoogleWorkspaceProvider Viewset
pub async fn providers_google_workspace_update(configuration: &configuration::Configuration, id: i32, google_workspace_provider_request: models::GoogleWorkspaceProviderRequest) -> Result<models::GoogleWorkspaceProvider, Error<ProvidersGoogleWorkspaceUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_google_workspace_provider_request = google_workspace_provider_request;
...
/// Get a list of all objects that use this object
pub async fn providers_google_workspace_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersGoogleWorkspaceUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/google_workspace/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_google_workspace_users_create(configuration: &configuration::Configuration, google_workspace_provider_user_request: models::GoogleWorkspaceProviderUserRequest) -> Result<models::GoogleWorkspaceProviderUser, Error<ProvidersGoogleWorkspaceUsersCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// GoogleWorkspaceProviderUser Viewset
pub async fn providers_google_workspace_users_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<ProvidersGoogleWorkspaceUsersDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/google_workspace_users/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// GoogleWorkspaceProviderUser Viewset
pub async fn providers_google_workspace_users_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, provider__id: Option<i32>, search: Option<&str>, user__id: Option<i32>, user__username: Option<&str>) -> Result<models::PaginatedGoogleWorkspaceProviderUserList, Error<ProvidersGoogleWorkspaceUsersListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// GoogleWorkspaceProviderUser Viewset
pub async fn providers_google_workspace_users_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::GoogleWorkspaceProviderUser, Error<ProvidersGoogleWorkspaceUsersRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Get a list of all objects that use this object
pub async fn providers_google_workspace_users_used_by_list(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::UsedBy>, Error<ProvidersGoogleWorkspaceUsersUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/google_workspace_users/{id}/used_by/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_ldap_create(configuration: &configuration::Configuration, ldap_provider_request: models::LdapProviderRequest) -> Result<models::LdapProvider, Error<ProvidersLdapCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::LdapProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::LdapProvider`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn providers_ldap_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersLdapUsedByListError>> {
    ...
    let uri_str = format!("{}/providers/ldap/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_microsoft_entra_create(configuration: &configuration::Configuration, microsoft_entra_provider_request: models::MicrosoftEntraProviderRequest) -> Result<models::MicrosoftEntraProvider, Error<ProvidersMicrosoftEntraCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// MicrosoftEntraProvider Viewset
pub async fn providers_microsoft_entra_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<ProvidersMicrosoftEntraDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/microsoft_entra/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_microsoft_entra_groups_create(configuration: &configuration::Configuration, microsoft_entra_provider_group_request: models::MicrosoftEntraProviderGroupRequest) -> Result<models::MicrosoftEntraProviderGroup, Error<ProvidersMicrosoftEntraGroupsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// MicrosoftEntraProviderGroup Viewset
pub async fn providers_microsoft_entra_groups_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<ProvidersMicrosoftEntraGroupsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/microsoft_entra_groups/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// MicrosoftEntraProviderGroup Viewset
pub async fn providers_microsoft_entra_groups_list(configuration: &configuration::Configuration, group__group_uuid: Option<&str>, group__name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, provider__id: Option<i32>, search: Option<&str>) -> Result<models::PaginatedMicrosoftEntraProviderGroupList, Error<ProvidersMicrosoftEntraGroupsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_group__group_uuid = group__group_uuid;
    let p_query_group__name = group__name;
    let p_query_ordering = ordering;
...
/// MicrosoftEntraProviderGroup Viewset
pub async fn providers_microsoft_entra_groups_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::MicrosoftEntraProviderGroup, Error<ProvidersMicrosoftEntraGroupsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Get a list of all objects that use this object
pub async fn providers_microsoft_entra_groups_used_by_list(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::UsedBy>, Error<ProvidersMicrosoftEntraGroupsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/microsoft_entra_groups/{id}/used_by/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// MicrosoftEntraProvider Viewset
pub async fn providers_microsoft_entra_list(configuration: &configuration::Configuration, exclude_users_service_account: Option<bool>, filter_group: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedMicrosoftEntraProviderList, Error<ProvidersMicrosoftEntraListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_exclude_users_service_account = exclude_users_service_account;
    let p_query_filter_group = filter_group;
    let p_query_name = name;
...
/// MicrosoftEntraProvider Viewset
pub async fn providers_microsoft_entra_partial_update(configuration: &configuration::Configuration, id: i32, patched_microsoft_entra_provider_request: Option<models::PatchedMicrosoftEntraProviderRequest>) -> Result<models::MicrosoftEntraProvider, Error<ProvidersMicrosoftEntraPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// MicrosoftEntraProvider Viewset
pub async fn providers_microsoft_entra_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::MicrosoftEntraProvider, Error<ProvidersMicrosoftEntraRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Sync/Re-sync a single user/group object
pub async fn providers_microsoft_entra_sync_object_create(configuration: &configuration::Configuration, id: i32, sync_object_request: models::SyncObjectRequest) -> Result<models::SyncObjectResult, Error<ProvidersMicrosoftEntraSyncObjectCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_sync_object_request = sync_object_request;

    let uri_str = format!("{}/providers/microsoft_entra/{id}/sync/object/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
/// Get provider's sync status
pub async fn providers_microsoft_entra_sync_status_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::SyncStatus, Error<ProvidersMicrosoftEntraSyncStatusRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/microsoft_entra/{id}/sync/status/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// MicrosoftEntraProvider Viewset
pub async fn providers_microsoft_entra_update(configuration: &configuration::Configuration, id: i32, microsoft_entra_provider_request: models::MicrosoftEntraProviderRequest) -> Result<models::MicrosoftEntraProvider, Error<ProvidersMicrosoftEntraUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_microsoft_entra_provider_request = microsoft_entra_provider_request;
...
/// Get a list of all objects that use this object
pub async fn providers_microsoft_entra_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersMicrosoftEntraUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/microsoft_entra/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_microsoft_entra_users_create(configuration: &configuration::Configuration, microsoft_entra_provider_user_request: models::MicrosoftEntraProviderUserRequest) -> Result<models::MicrosoftEntraProviderUser, Error<ProvidersMicrosoftEntraUsersCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// MicrosoftEntraProviderUser Viewset
pub async fn providers_microsoft_entra_users_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<ProvidersMicrosoftEntraUsersDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/microsoft_entra_users/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// MicrosoftEntraProviderUser Viewset
pub async fn providers_microsoft_entra_users_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, provider__id: Option<i32>, search: Option<&str>, user__id: Option<i32>, user__username: Option<&str>) -> Result<models::PaginatedMicrosoftEntraProviderUserList, Error<ProvidersMicrosoftEntraUsersListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// MicrosoftEntraProviderUser Viewset
pub async fn providers_microsoft_entra_users_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::MicrosoftEntraProviderUser, Error<ProvidersMicrosoftEntraUsersRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Get a list of all objects that use this object
pub async fn providers_microsoft_entra_users_used_by_list(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::UsedBy>, Error<ProvidersMicrosoftEntraUsersUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/microsoft_entra_users/{id}/used_by/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_oauth2_create(configuration: &configuration::Configuration, o_auth2_provider_request: models::OAuth2ProviderRequest) -> Result<models::OAuth2Provider, Error<ProvidersOauth2CreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::OAuth2Provider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::OAuth2Provider`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// OAuth2Provider Viewset
pub async fn providers_oauth2_list(configuration: &configuration::Configuration, access_code_validity: Option<&str>, access_token_validity: Option<&str>, application: Option<&str>, authorization_flow: Option<&str>, client_id: Option<&str>, client_type: Option<models::ClientTypeEnum>, include_claims_in_id_token: Option<bool>, issuer_mode: Option<models::IssuerModeEnum>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, property_mappings: Option<Vec<uuid::Uuid>>, refresh_token_validity: Option<&str>, search: Option<&str>, signing_key: Option<&str>, sub_mode: Option<models::SubModeEnum>) -> Result<models::PaginatedOAuth2ProviderList, Error<ProvidersOauth2ListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_property_mappings {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("property_mappings".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("property_mappings", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn providers_oauth2_preview_user_retrieve(configuration: &configuration::Configuration, id: i32, for_user: Option<i32>) -> Result<models::PropertyMappingPreview, Error<ProvidersOauth2PreviewUserRetrieveError>> {
    ...
    let uri_str = format!("{}/providers/oauth2/{id}/preview_user/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_oauth2_setup_urls_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::OAuth2ProviderSetupUrls, Error<ProvidersOauth2SetupUrlsRetrieveError>> {
    ...
    let uri_str = format!("{}/providers/oauth2/{id}/setup_urls/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_oauth2_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersOauth2UsedByListError>> {
    ...
    let uri_str = format!("{}/providers/oauth2/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_proxy_create(configuration: &configuration::Configuration, proxy_provider_request: models::ProxyProviderRequest) -> Result<models::ProxyProvider, Error<ProvidersProxyCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProxyProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProxyProvider`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn providers_proxy_list(configuration: &configuration::Configuration, application__isnull: Option<bool>, authorization_flow__slug__iexact: Option<&str>, basic_auth_enabled__iexact: Option<bool>, basic_auth_password_attribute__iexact: Option<&str>, basic_auth_user_attribute__iexact: Option<&str>, certificate__kp_uuid__iexact: Option<&str>, certificate__name__iexact: Option<&str>, cookie_domain__iexact: Option<&str>, external_host__iexact: Option<&str>, internal_host__iexact: Option<&str>, internal_host_ssl_validation__iexact: Option<bool>, mode__iexact: Option<&str>, name__iexact: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, property_mappings__iexact: Option<Vec<uuid::Uuid>>, search: Option<&str>, skip_path_regex__iexact: Option<&str>) -> Result<models::PaginatedProxyProviderList, Error<ProvidersProxyListError>> {
    ...
    if let Some(ref param_value) = p_query_property_mappings__iexact {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("property_mappings__iexact".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("property_mappings__iexact", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_search {
        req_builder = req_builder.query(&[("search", &param_value.to_string())]);
...
pub async fn providers_proxy_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersProxyUsedByListError>> {
    ...
    let uri_str = format!("{}/providers/proxy/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_rac_create(configuration: &configuration::Configuration, rac_provider_request: models::RacProviderRequest) -> Result<models::RacProvider, Error<ProvidersRacCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RacProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RacProvider`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn providers_rac_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersRacUsedByListError>> {
    ...
    let uri_str = format!("{}/providers/rac/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_radius_create(configuration: &configuration::Configuration, radius_provider_request: models::RadiusProviderRequest) -> Result<models::RadiusProvider, Error<ProvidersRadiusCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RadiusProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RadiusProvider`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn providers_radius_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersRadiusUsedByListError>> {
    ...
    let uri_str = format!("{}/providers/radius/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_saml_create(configuration: &configuration::Configuration, saml_provider_request: models::SamlProviderRequest) -> Result<models::SamlProvider, Error<ProvidersSamlCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SamlProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SamlProvider`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn providers_saml_import_metadata_create(configuration: &configuration::Configuration, name: &str, authorization_flow: &str, invalidation_flow: &str, file: std::path::PathBuf) -> Result<models::SamlProvider, Error<ProvidersSamlImportMetadataCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SAMLProvider Viewset
pub async fn providers_saml_list(configuration: &configuration::Configuration, acs_url: Option<&str>, assertion_valid_not_before: Option<&str>, assertion_valid_not_on_or_after: Option<&str>, audience: Option<&str>, authentication_flow: Option<&str>, authn_context_class_ref_mapping: Option<&str>, authorization_flow: Option<&str>, backchannel_application: Option<&str>, default_name_id_policy: Option<models::SamlNameIdPolicyEnum>, default_relay_state: Option<&str>, digest_algorithm: Option<models::DigestAlgorithmEnum>, encryption_kp: Option<&str>, invalidation_flow: Option<&str>, is_backchannel: Option<bool>, issuer: Option<&str>, logout_method: Option<models::SamlLogoutMethods>, name: Option<&str>, name_id_mapping: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, property_mappings: Option<Vec<uuid::Uuid>>, search: Option<&str>, session_valid_not_on_or_after: Option<&str>, sign_assertion: Option<bool>, sign_logout_request: Option<bool>, sign_logout_response: Option<bool>, sign_response: Option<bool>, signature_algorithm: Option<models::SignatureAlgorithmEnum>, signing_kp: Option<&str>, sls_binding: Option<models::SamlBindingsEnum>, sls_url: Option<&str>, sp_binding: Option<models::SamlBindingsEnum>, verification_kp: Option<&str>) -> Result<models::PaginatedSamlProviderList, Error<ProvidersSamlListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn providers_saml_metadata_retrieve(configuration: &configuration::Configuration, id: i32, download: Option<bool>, force_binding: Option<&str>) -> Result<models::SamlMetadata, Error<ProvidersSamlMetadataRetrieveError>> {
    ...
    let uri_str = format!("{}/providers/saml/{id}/metadata/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_saml_preview_user_retrieve(configuration: &configuration::Configuration, id: i32, for_user: Option<i32>) -> Result<models::PropertyMappingPreview, Error<ProvidersSamlPreviewUserRetrieveError>> {
    ...
    let uri_str = format!("{}/providers/saml/{id}/preview_user/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_saml_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersSamlUsedByListError>> {
    ...
    let uri_str = format!("{}/providers/saml/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_scim_create(configuration: &configuration::Configuration, scim_provider_request: models::ScimProviderRequest) -> Result<models::ScimProvider, Error<ProvidersScimCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScimProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScimProvider`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn providers_scim_groups_create(configuration: &configuration::Configuration, scim_provider_group_request: models::ScimProviderGroupRequest) -> Result<models::ScimProviderGroup, Error<ProvidersScimGroupsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SCIMProviderGroup Viewset
pub async fn providers_scim_groups_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<ProvidersScimGroupsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/scim_groups/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SCIMProviderGroup Viewset
pub async fn providers_scim_groups_list(configuration: &configuration::Configuration, group__group_uuid: Option<&str>, group__name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, provider__id: Option<i32>, search: Option<&str>) -> Result<models::PaginatedScimProviderGroupList, Error<ProvidersScimGroupsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_group__group_uuid = group__group_uuid;
    let p_query_group__name = group__name;
    let p_query_ordering = ordering;
...
/// SCIMProviderGroup Viewset
pub async fn providers_scim_groups_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::ScimProviderGroup, Error<ProvidersScimGroupsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Get a list of all objects that use this object
pub async fn providers_scim_groups_used_by_list(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::UsedBy>, Error<ProvidersScimGroupsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/scim_groups/{id}/used_by/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// SCIMProvider Viewset
pub async fn providers_scim_list(configuration: &configuration::Configuration, exclude_users_service_account: Option<bool>, group_filters: Option<Vec<uuid::Uuid>>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, url: Option<&str>) -> Result<models::PaginatedScimProviderList, Error<ProvidersScimListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_exclude_users_service_account = exclude_users_service_account;
    ...
    if let Some(ref param_value) = p_query_group_filters {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("group_filters".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("group_filters", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_name {
        req_builder = req_builder.query(&[("name", &param_value.to_string())]);
...
/// Sync/Re-sync a single user/group object
pub async fn providers_scim_sync_object_create(configuration: &configuration::Configuration, id: i32, sync_object_request: models::SyncObjectRequest) -> Result<models::SyncObjectResult, Error<ProvidersScimSyncObjectCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_sync_object_request = sync_object_request;

    let uri_str = format!("{}/providers/scim/{id}/sync/object/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
/// Get provider's sync status
pub async fn providers_scim_sync_status_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::SyncStatus, Error<ProvidersScimSyncStatusRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/scim/{id}/sync/status/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_scim_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersScimUsedByListError>> {
    ...
    let uri_str = format!("{}/providers/scim/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_scim_users_create(configuration: &configuration::Configuration, scim_provider_user_request: models::ScimProviderUserRequest) -> Result<models::ScimProviderUser, Error<ProvidersScimUsersCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SCIMProviderUser Viewset
pub async fn providers_scim_users_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<ProvidersScimUsersDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/scim_users/{id}/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SCIMProviderUser Viewset
pub async fn providers_scim_users_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, provider__id: Option<i32>, search: Option<&str>, user__id: Option<i32>, user__username: Option<&str>) -> Result<models::PaginatedScimProviderUserList, Error<ProvidersScimUsersListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// SCIMProviderUser Viewset
pub async fn providers_scim_users_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<models::ScimProviderUser, Error<ProvidersScimUsersRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Get a list of all objects that use this object
pub async fn providers_scim_users_used_by_list(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::UsedBy>, Error<ProvidersScimUsersUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/scim_users/{id}/used_by/", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// SSFProvider Viewset
pub async fn providers_ssf_create(configuration: &configuration::Configuration, ssf_provider_request: models::SsfProviderRequest) -> Result<models::SsfProvider, Error<ProvidersSsfCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SsfProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SsfProvider`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// SSFProvider Viewset
pub async fn providers_ssf_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<ProvidersSsfDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// SSFProvider Viewset
pub async fn providers_ssf_list(configuration: &configuration::Configuration, application__isnull: Option<bool>, name__iexact: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedSsfProviderList, Error<ProvidersSsfListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_application__isnull = application__isnull;
    let p_query_name__iexact = name__iexact;
    let p_query_ordering = ordering;
...
/// SSFProvider Viewset
pub async fn providers_ssf_partial_update(configuration: &configuration::Configuration, id: i32, patched_ssf_provider_request: Option<models::PatchedSsfProviderRequest>) -> Result<models::SsfProvider, Error<ProvidersSsfPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// SSFProvider Viewset
pub async fn providers_ssf_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::SsfProvider, Error<ProvidersSsfRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// SSFProvider Viewset
pub async fn providers_ssf_update(configuration: &configuration::Configuration, id: i32, ssf_provider_request: models::SsfProviderRequest) -> Result<models::SsfProvider, Error<ProvidersSsfUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_ssf_provider_request = ssf_provider_request;
...
/// Get a list of all objects that use this object
pub async fn providers_ssf_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersSsfUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/ssf/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_wsfed_create(configuration: &configuration::Configuration, ws_federation_provider_request: models::WsFederationProviderRequest) -> Result<models::WsFederationProvider, Error<ProvidersWsfedCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WsFederationProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WsFederationProvider`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// WSFederationProvider Viewset
pub async fn providers_wsfed_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<ProvidersWsfedDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/wsfed/{id}/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// WSFederationProvider Viewset
pub async fn providers_wsfed_list(configuration: &configuration::Configuration, acs_url: Option<&str>, assertion_valid_not_before: Option<&str>, assertion_valid_not_on_or_after: Option<&str>, audience: Option<&str>, authentication_flow: Option<&str>, authn_context_class_ref_mapping: Option<&str>, authorization_flow: Option<&str>, backchannel_application: Option<&str>, default_name_id_policy: Option<models::SamlNameIdPolicyEnum>, default_relay_state: Option<&str>, digest_algorithm: Option<models::DigestAlgorithmEnum>, encryption_kp: Option<&str>, invalidation_flow: Option<&str>, is_backchannel: Option<bool>, issuer: Option<&str>, logout_method: Option<models::SamlLogoutMethods>, name: Option<&str>, name_id_mapping: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, property_mappings: Option<Vec<uuid::Uuid>>, search: Option<&str>, session_valid_not_on_or_after: Option<&str>, sign_assertion: Option<bool>, sign_logout_request: Option<bool>, sign_logout_response: Option<bool>, sign_response: Option<bool>, signature_algorithm: Option<models::SignatureAlgorithmEnum>, signing_kp: Option<&str>, sls_binding: Option<models::SamlBindingsEnum>, sls_url: Option<&str>, sp_binding: Option<models::SamlBindingsEnum>, verification_kp: Option<&str>) -> Result<models::PaginatedWsFederationProviderList, Error<ProvidersWsfedListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_acs_url = acs_url;
    let p_query_assertion_valid_not_before = assertion_valid_not_before;
    let p_query_assertion_valid_not_on_or_after = assertion_valid_not_on_or_after;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginatedWsFederationProviderList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginatedWsFederationProviderList`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Return metadata as XML string
pub async fn providers_wsfed_metadata_retrieve(configuration: &configuration::Configuration, id: i32, download: Option<bool>, force_binding: Option<&str>) -> Result<models::SamlMetadata, Error<ProvidersWsfedMetadataRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_query_download = download;
    let p_query_force_binding = force_binding;

    let uri_str = format!("{}/providers/wsfed/{id}/metadata/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ProvidersWsfedMetadataRetrieveError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// WSFederationProvider Viewset
pub async fn providers_wsfed_partial_update(configuration: &configuration::Configuration, id: i32, patched_ws_federation_provider_request: Option<models::PatchedWsFederationProviderRequest>) -> Result<models::WsFederationProvider, Error<ProvidersWsfedPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// Preview user data for provider
pub async fn providers_wsfed_preview_user_retrieve(configuration: &configuration::Configuration, id: i32, for_user: Option<i32>) -> Result<models::PropertyMappingPreview, Error<ProvidersWsfedPreviewUserRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_query_for_user = for_user;

    let uri_str = format!("{}/providers/wsfed/{id}/preview_user/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ProvidersWsfedPreviewUserRetrieveError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// WSFederationProvider Viewset
pub async fn providers_wsfed_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::WsFederationProvider, Error<ProvidersWsfedRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// WSFederationProvider Viewset
pub async fn providers_wsfed_update(configuration: &configuration::Configuration, id: i32, ws_federation_provider_request: models::WsFederationProviderRequest) -> Result<models::WsFederationProvider, Error<ProvidersWsfedUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_ws_federation_provider_request = ws_federation_provider_request;
...
/// Get a list of all objects that use this object
pub async fn providers_wsfed_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<ProvidersWsfedUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/providers/wsfed/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
