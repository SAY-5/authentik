...
pub async fn events_events_destroy(configuration: &configuration::Configuration, event_uuid: &str) -> Result<(), Error<EventsEventsDestroyError>> {
    ...
    let uri_str = format!("{}/events/events/{event_uuid}/", configuration.base_path, event_uuid=crate::apis::urlencode(p_path_event_uuid));
...
pub async fn events_events_export_create(configuration: &configuration::Configuration, action: Option<&str>, actions: Option<Vec<models::EventActions>>, brand_name: Option<&str>, client_ip: Option<&str>, context_authorized_app: Option<&str>, context_device: Option<&str>, context_model_app: Option<&str>, context_model_name: Option<&str>, context_model_pk: Option<&str>, ordering: Option<&str>, search: Option<&str>, username: Option<&str>) -> Result<models::DataExport, Error<EventsEventsExportCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Event Read-Only Viewset
pub async fn events_events_list(configuration: &configuration::Configuration, action: Option<&str>, actions: Option<Vec<models::EventActions>>, brand_name: Option<&str>, client_ip: Option<&str>, context_authorized_app: Option<&str>, context_device: Option<&str>, context_model_app: Option<&str>, context_model_name: Option<&str>, context_model_pk: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, username: Option<&str>) -> Result<models::PaginatedEventList, Error<EventsEventsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_action = action;
    let p_query_actions = actions;
    let p_query_brand_name = brand_name;
...
pub async fn events_events_stats_retrieve(configuration: &configuration::Configuration, count_steps: Vec<String>, action: Option<&str>, actions: Option<Vec<models::EventActions>>, brand_name: Option<&str>, client_ip: Option<&str>, context_authorized_app: Option<&str>, context_device: Option<&str>, context_model_app: Option<&str>, context_model_name: Option<&str>, context_model_pk: Option<&str>, ordering: Option<&str>, search: Option<&str>, username: Option<&str>) -> Result<models::EventStats, Error<EventsEventsStatsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = match "multi" {
        "multi" => req_builder.query(&p_query_count_steps.into_iter().map(|p| ("count_steps".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("count_steps", &p_query_count_steps.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_query_ordering {
        req_builder = req_builder.query(&[("ordering", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EventStats`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EventStats`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn events_events_volume_list(configuration: &configuration::Configuration, action: Option<&str>, actions: Option<Vec<models::EventActions>>, brand_name: Option<&str>, client_ip: Option<&str>, context_authorized_app: Option<&str>, context_device: Option<&str>, context_model_app: Option<&str>, context_model_name: Option<&str>, context_model_pk: Option<&str>, history_days: Option<i32>, ordering: Option<&str>, search: Option<&str>, username: Option<&str>) -> Result<Vec<models::EventVolume>, Error<EventsEventsVolumeListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_action = action;
    let p_query_actions = actions;
    let p_query_brand_name = brand_name;
...
pub async fn events_notifications_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<EventsNotificationsDestroyError>> {
    ...
    let uri_str = format!("{}/events/notifications/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn events_notifications_used_by_list(configuration: &configuration::Configuration, uuid: &str) -> Result<Vec<models::UsedBy>, Error<EventsNotificationsUsedByListError>> {
    ...
    let uri_str = format!("{}/events/notifications/{uuid}/used_by/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn events_rules_destroy(configuration: &configuration::Configuration, pbm_uuid: &str) -> Result<(), Error<EventsRulesDestroyError>> {
    ...
    let uri_str = format!("{}/events/rules/{pbm_uuid}/", configuration.base_path, pbm_uuid=crate::apis::urlencode(p_path_pbm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// NotificationRule Viewset
pub async fn events_rules_list(configuration: &configuration::Configuration, destination_group__name: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, severity: Option<models::SeverityEnum>) -> Result<models::PaginatedNotificationRuleList, Error<EventsRulesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn events_rules_used_by_list(configuration: &configuration::Configuration, pbm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EventsRulesUsedByListError>> {
    ...
    let uri_str = format!("{}/events/rules/{pbm_uuid}/used_by/", configuration.base_path, pbm_uuid=crate::apis::urlencode(p_path_pbm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn events_transports_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<EventsTransportsDestroyError>> {
    ...
    let uri_str = format!("{}/events/transports/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// NotificationTransport Viewset
pub async fn events_transports_list(configuration: &configuration::Configuration, mode: Option<models::TransportModeEnum>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, send_once: Option<bool>, webhook_url: Option<&str>) -> Result<models::PaginatedNotificationTransportList, Error<EventsTransportsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn events_transports_test_create(configuration: &configuration::Configuration, uuid: &str) -> Result<models::NotificationTransportTest, Error<EventsTransportsTestCreateError>> {
    ...
    let uri_str = format!("{}/events/transports/{uuid}/test/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn events_transports_used_by_list(configuration: &configuration::Configuration, uuid: &str) -> Result<Vec<models::UsedBy>, Error<EventsTransportsUsedByListError>> {
    ...
    let uri_str = format!("{}/events/transports/{uuid}/used_by/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
