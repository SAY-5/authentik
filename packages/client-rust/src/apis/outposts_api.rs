...
pub async fn outposts_instances_create(configuration: &configuration::Configuration, outpost_request: models::OutpostRequest) -> Result<models::Outpost, Error<OutpostsInstancesCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Outpost`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Outpost`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn outposts_instances_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<OutpostsInstancesDestroyError>> {
    ...
    let uri_str = format!("{}/outposts/instances/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
...
pub async fn outposts_instances_health_list(configuration: &configuration::Configuration, uuid: &str, managed__icontains: Option<&str>, managed__iexact: Option<&str>, name__icontains: Option<&str>, name__iexact: Option<&str>, ordering: Option<&str>, providers__isnull: Option<bool>, providers_by_pk: Option<Vec<i32>>, search: Option<&str>, service_connection__name__icontains: Option<&str>, service_connection__name__iexact: Option<&str>) -> Result<Vec<models::OutpostHealth>, Error<OutpostsInstancesHealthListError>> {
    ...
    let uri_str = format!("{}/outposts/instances/{uuid}/health/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn outposts_instances_used_by_list(configuration: &configuration::Configuration, uuid: &str) -> Result<Vec<models::UsedBy>, Error<OutpostsInstancesUsedByListError>> {
    ...
    let uri_str = format!("{}/outposts/instances/{uuid}/used_by/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn outposts_service_connections_all_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<OutpostsServiceConnectionsAllDestroyError>> {
    ...
    let uri_str = format!("{}/outposts/service_connections/all/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn outposts_service_connections_all_state_retrieve(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ServiceConnectionState, Error<OutpostsServiceConnectionsAllStateRetrieveError>> {
    ...
    let uri_str = format!("{}/outposts/service_connections/all/{uuid}/state/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn outposts_service_connections_all_used_by_list(configuration: &configuration::Configuration, uuid: &str) -> Result<Vec<models::UsedBy>, Error<OutpostsServiceConnectionsAllUsedByListError>> {
    ...
    let uri_str = format!("{}/outposts/service_connections/all/{uuid}/used_by/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn outposts_service_connections_docker_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<OutpostsServiceConnectionsDockerDestroyError>> {
    ...
    let uri_str = format!("{}/outposts/service_connections/docker/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn outposts_service_connections_docker_used_by_list(configuration: &configuration::Configuration, uuid: &str) -> Result<Vec<models::UsedBy>, Error<OutpostsServiceConnectionsDockerUsedByListError>> {
    ...
    let uri_str = format!("{}/outposts/service_connections/docker/{uuid}/used_by/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn outposts_service_connections_kubernetes_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<OutpostsServiceConnectionsKubernetesDestroyError>> {
    ...
    let uri_str = format!("{}/outposts/service_connections/kubernetes/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn outposts_service_connections_kubernetes_partial_update(configuration: &configuration::Configuration, uuid: &str, patched_kubernetes_service_connection_request: Option<models::PatchedKubernetesServiceConnectionRequest>) -> Result<models::KubernetesServiceConnection, Error<OutpostsServiceConnectionsKubernetesPartialUpdateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OutpostsServiceConnectionsKubernetesPartialUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn outposts_service_connections_kubernetes_used_by_list(configuration: &configuration::Configuration, uuid: &str) -> Result<Vec<models::UsedBy>, Error<OutpostsServiceConnectionsKubernetesUsedByListError>> {
    ...
    let uri_str = format!("{}/outposts/service_connections/kubernetes/{uuid}/used_by/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
