...
pub async fn crypto_certificatekeypairs_destroy(configuration: &configuration::Configuration, kp_uuid: &str) -> Result<(), Error<CryptoCertificatekeypairsDestroyError>> {
    ...
    let uri_str = format!("{}/crypto/certificatekeypairs/{kp_uuid}/", configuration.base_path, kp_uuid=crate::apis::urlencode(p_path_kp_uuid));
...
/// CertificateKeyPair Viewset
pub async fn crypto_certificatekeypairs_list(configuration: &configuration::Configuration, has_key: Option<bool>, key_type: Option<Vec<models::KeyTypeEnum>>, managed: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedCertificateKeyPairList, Error<CryptoCertificatekeypairsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_key_type {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("key_type".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("key_type", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn crypto_certificatekeypairs_used_by_list(configuration: &configuration::Configuration, kp_uuid: &str) -> Result<Vec<models::UsedBy>, Error<CryptoCertificatekeypairsUsedByListError>> {
    ...
    let uri_str = format!("{}/crypto/certificatekeypairs/{kp_uuid}/used_by/", configuration.base_path, kp_uuid=crate::apis::urlencode(p_path_kp_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn crypto_certificatekeypairs_view_certificate_retrieve(configuration: &configuration::Configuration, kp_uuid: &str, download: Option<bool>) -> Result<models::CertificateData, Error<CryptoCertificatekeypairsViewCertificateRetrieveError>> {
    ...
    let uri_str = format!("{}/crypto/certificatekeypairs/{kp_uuid}/view_certificate/", configuration.base_path, kp_uuid=crate::apis::urlencode(p_path_kp_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CertificateData`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CertificateData`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn crypto_certificatekeypairs_view_private_key_retrieve(configuration: &configuration::Configuration, kp_uuid: &str, download: Option<bool>) -> Result<models::CertificateData, Error<CryptoCertificatekeypairsViewPrivateKeyRetrieveError>> {
    ...
    let uri_str = format!("{}/crypto/certificatekeypairs/{kp_uuid}/view_private_key/", configuration.base_path, kp_uuid=crate::apis::urlencode(p_path_kp_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
