...
/// struct for typed errors of method [`core_object_attributes_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CoreObjectAttributesCreateError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`core_object_attributes_destroy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CoreObjectAttributesDestroyError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`core_object_attributes_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CoreObjectAttributesListError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`core_object_attributes_partial_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CoreObjectAttributesPartialUpdateError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`core_object_attributes_retrieve`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CoreObjectAttributesRetrieveError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`core_object_attributes_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CoreObjectAttributesUpdateError {
    Status400(models::ValidationError),
    Status403(models::GenericError),
    UnknownValue(serde_json::Value),
}
...
pub async fn core_object_attributes_create(
...
) -> Result<models::ObjectAttribute, Error<CoreObjectAttributesCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_object_attribute_request = object_attribute_request;
    ...
    req_builder = req_builder.json(&p_body_object_attribute_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CoreObjectAttributesCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn core_object_attributes_destroy(
    configuration: &configuration::Configuration,
    attribute_id: &str,
) -> Result<(), Error<CoreObjectAttributesDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CoreObjectAttributesDestroyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn core_object_attributes_list(
    ...
    if let Some(ref param_value) = p_query_object_type__model {
        req_builder = req_builder.query(&[("object_type__model", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_ordering {
        req_builder = req_builder.query(&[("ordering", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to \
                     `models::PaginatedObjectAttributeList`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
        ...
        let content = resp.text().await?;
        let entity: Option<CoreObjectAttributesListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn core_object_attributes_partial_update(
    configuration: &configuration::Configuration,
    attribute_id: &str,
    patched_object_attribute_request: Option<models::PatchedObjectAttributeRequest>,
) -> Result<models::ObjectAttribute, Error<CoreObjectAttributesPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_attribute_id = attribute_id;
    let p_body_patched_object_attribute_request = patched_object_attribute_request;
    ...
    req_builder = req_builder.json(&p_body_patched_object_attribute_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CoreObjectAttributesPartialUpdateError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn core_object_attributes_retrieve(
    configuration: &configuration::Configuration,
    attribute_id: &str,
) -> Result<models::ObjectAttribute, Error<CoreObjectAttributesRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_attribute_id = attribute_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CoreObjectAttributesRetrieveError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn core_object_attributes_update(
    ...
    attribute_id: &str,
    object_attribute_request: models::ObjectAttributeRequest,
) -> Result<models::ObjectAttribute, Error<CoreObjectAttributesUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_attribute_id = attribute_id;
    let p_body_object_attribute_request = object_attribute_request;
