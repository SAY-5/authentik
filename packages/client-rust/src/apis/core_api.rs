...
/// struct for typed errors of method [`core_users_account_lockdown_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CoreUsersAccountLockdownCreateError {
    Status400(),
    Status403(),
    UnknownValue(serde_json::Value),
}
...
pub async fn core_application_entitlements_create(configuration: &configuration::Configuration, application_entitlement_request: models::ApplicationEntitlementRequest) -> Result<models::ApplicationEntitlement, Error<CoreApplicationEntitlementsCreateError>> {
...
/// ApplicationEntitlement Viewset
pub async fn core_application_entitlements_destroy(configuration: &configuration::Configuration, pbm_uuid: &str) -> Result<(), Error<CoreApplicationEntitlementsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;

    let uri_str = format!("{}/core/application_entitlements/{pbm_uuid}/", configuration.base_path, pbm_uuid=crate::apis::urlencode(p_path_pbm_uuid));
...
/// ApplicationEntitlement Viewset
pub async fn core_application_entitlements_list(configuration: &configuration::Configuration, app: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, search: Option<&str>) -> Result<models::PaginatedApplicationEntitlementList, Error<CoreApplicationEntitlementsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_app = app;
...
/// ApplicationEntitlement Viewset
pub async fn core_application_entitlements_partial_update(configuration: &configuration::Configuration, pbm_uuid: &str, patched_application_entitlement_request: Option<models::PatchedApplicationEntitlementRequest>) -> Result<models::ApplicationEntitlement, Error<CoreApplicationEntitlementsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;
...
/// ApplicationEntitlement Viewset
pub async fn core_application_entitlements_retrieve(configuration: &configuration::Configuration, pbm_uuid: &str) -> Result<models::ApplicationEntitlement, Error<CoreApplicationEntitlementsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;
...
/// ApplicationEntitlement Viewset
pub async fn core_application_entitlements_update(configuration: &configuration::Configuration, pbm_uuid: &str, application_entitlement_request: models::ApplicationEntitlementRequest) -> Result<models::ApplicationEntitlement, Error<CoreApplicationEntitlementsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;
    let p_body_application_entitlement_request = application_entitlement_request;
...
pub async fn core_application_entitlements_used_by_list(configuration: &configuration::Configuration, pbm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<CoreApplicationEntitlementsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;

    let uri_str = format!("{}/core/application_entitlements/{pbm_uuid}/used_by/", configuration.base_path, pbm_uuid=crate::apis::urlencode(p_path_pbm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_applications_check_access_retrieve(configuration: &configuration::Configuration, slug: &str, for_user: Option<i32>) -> Result<models::PolicyTestResult, Error<CoreApplicationsCheckAccessRetrieveError>> {
    ...
    let uri_str = format!("{}/core/applications/{slug}/check_access/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_applications_destroy(configuration: &configuration::Configuration, slug: &str) -> Result<(), Error<CoreApplicationsDestroyError>> {
    ...
    let uri_str = format!("{}/core/applications/{slug}/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn core_applications_used_by_list(configuration: &configuration::Configuration, slug: &str) -> Result<Vec<models::UsedBy>, Error<CoreApplicationsUsedByListError>> {
    ...
    let uri_str = format!("{}/core/applications/{slug}/used_by/", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_authenticated_sessions_bulk_delete_destroy(configuration: &configuration::Configuration, user_pks: Vec<i32>) -> Result<models::BulkDeleteSessionResponse, Error<CoreAuthenticatedSessionsBulkDeleteDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_user_pks = user_pks;

    let uri_str = format!("{}/core/authenticated_sessions/bulk_delete/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);

    req_builder = match "multi" {
        "multi" => req_builder.query(&p_query_user_pks.into_iter().map(|p| ("user_pks".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("user_pks", &p_query_user_pks.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BulkDeleteSessionResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BulkDeleteSessionResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CoreAuthenticatedSessionsBulkDeleteDestroyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn core_authenticated_sessions_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<CoreAuthenticatedSessionsDestroyError>> {
    ...
    let uri_str = format!("{}/core/authenticated_sessions/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// AuthenticatedSession Viewset
pub async fn core_authenticated_sessions_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, session__last_ip: Option<&str>, session__last_user_agent: Option<&str>, user__username: Option<&str>) -> Result<models::PaginatedAuthenticatedSessionList, Error<CoreAuthenticatedSessionsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
pub async fn core_authenticated_sessions_used_by_list(configuration: &configuration::Configuration, uuid: &str) -> Result<Vec<models::UsedBy>, Error<CoreAuthenticatedSessionsUsedByListError>> {
    ...
    let uri_str = format!("{}/core/authenticated_sessions/{uuid}/used_by/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_brands_create(configuration: &configuration::Configuration, brand_request: models::BrandRequest) -> Result<models::Brand, Error<CoreBrandsCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Brand`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Brand`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn core_brands_current_retrieve(configuration: &configuration::Configuration, ) -> Result<models::CurrentBrand, Error<CoreBrandsCurrentRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CurrentBrand`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CurrentBrand`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn core_brands_destroy(configuration: &configuration::Configuration, brand_uuid: &str) -> Result<(), Error<CoreBrandsDestroyError>> {
    ...
    let uri_str = format!("{}/core/brands/{brand_uuid}/", configuration.base_path, brand_uuid=crate::apis::urlencode(p_path_brand_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn core_brands_list(configuration: &configuration::Configuration, brand_uuid: Option<&str>, branding_default_flow_background: Option<&str>, branding_favicon: Option<&str>, branding_logo: Option<&str>, branding_title: Option<&str>, client_certificates: Option<Vec<uuid::Uuid>>, default: Option<bool>, domain: Option<&str>, flow_authentication: Option<&str>, flow_device_code: Option<&str>, flow_invalidation: Option<&str>, flow_lockdown: Option<&str>, flow_recovery: Option<&str>, flow_unenrollment: Option<&str>, flow_user_settings: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, web_certificate: Option<&str>) -> Result<models::PaginatedBrandList, Error<CoreBrandsListError>> {
    ...
    if let Some(ref param_value) = p_query_branding_default_flow_background {
        req_builder = req_builder.query(&[("branding_default_flow_background", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_query_client_certificates {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("client_certificates".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("client_certificates", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn core_brands_used_by_list(configuration: &configuration::Configuration, brand_uuid: &str) -> Result<Vec<models::UsedBy>, Error<CoreBrandsUsedByListError>> {
    ...
    let uri_str = format!("{}/core/brands/{brand_uuid}/used_by/", configuration.base_path, brand_uuid=crate::apis::urlencode(p_path_brand_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_groups_add_user_create(configuration: &configuration::Configuration, group_uuid: &str, user_account_request: models::UserAccountRequest) -> Result<(), Error<CoreGroupsAddUserCreateError>> {
    ...
    let uri_str = format!("{}/core/groups/{group_uuid}/add_user/", configuration.base_path, group_uuid=crate::apis::urlencode(p_path_group_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn core_groups_destroy(configuration: &configuration::Configuration, group_uuid: &str) -> Result<(), Error<CoreGroupsDestroyError>> {
    ...
    let uri_str = format!("{}/core/groups/{group_uuid}/", configuration.base_path, group_uuid=crate::apis::urlencode(p_path_group_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
>>>>>>> 0ab8796717 (gen: regenerate schema and clients)
/// Group Viewset
pub async fn core_groups_list(configuration: &configuration::Configuration, attributes: Option<&str>, include_children: Option<bool>, include_inherited_roles: Option<bool>, include_parents: Option<bool>, include_users: Option<bool>, is_superuser: Option<bool>, members_by_pk: Option<Vec<i32>>, members_by_username: Option<Vec<String>>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedGroupList, Error<CoreGroupsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_members_by_pk {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("members_by_pk".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("members_by_pk", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_members_by_username {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("members_by_username".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("members_by_username", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_name {
        req_builder = req_builder.query(&[("name", &param_value.to_string())]);
...
pub async fn core_groups_remove_user_create(configuration: &configuration::Configuration, group_uuid: &str, user_account_request: models::UserAccountRequest) -> Result<(), Error<CoreGroupsRemoveUserCreateError>> {
    ...
    let uri_str = format!("{}/core/groups/{group_uuid}/remove_user/", configuration.base_path, group_uuid=crate::apis::urlencode(p_path_group_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
/// Group Viewset
pub async fn core_groups_retrieve(configuration: &configuration::Configuration, group_uuid: &str, include_children: Option<bool>, include_inherited_roles: Option<bool>, include_parents: Option<bool>, include_users: Option<bool>) -> Result<models::Group, Error<CoreGroupsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_group_uuid = group_uuid;
    let p_query_include_children = include_children;
    let p_query_include_inherited_roles = include_inherited_roles;
...
pub async fn core_groups_used_by_list(configuration: &configuration::Configuration, group_uuid: &str) -> Result<Vec<models::UsedBy>, Error<CoreGroupsUsedByListError>> {
    ...
    let uri_str = format!("{}/core/groups/{group_uuid}/used_by/", configuration.base_path, group_uuid=crate::apis::urlencode(p_path_group_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_tokens_destroy(configuration: &configuration::Configuration, identifier: &str) -> Result<(), Error<CoreTokensDestroyError>> {
    ...
    let uri_str = format!("{}/core/tokens/{identifier}/", configuration.base_path, identifier=crate::apis::urlencode(p_path_identifier));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Token Viewset
pub async fn core_tokens_list(configuration: &configuration::Configuration, description: Option<&str>, expires: Option<String>, expiring: Option<bool>, identifier: Option<&str>, intent: Option<models::IntentEnum>, managed: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, user__username: Option<&str>) -> Result<models::PaginatedTokenList, Error<CoreTokensListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn core_tokens_set_key_create(configuration: &configuration::Configuration, identifier: &str, token_set_key_request: models::TokenSetKeyRequest) -> Result<(), Error<CoreTokensSetKeyCreateError>> {
    ...
    let uri_str = format!("{}/core/tokens/{identifier}/set_key/", configuration.base_path, identifier=crate::apis::urlencode(p_path_identifier));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn core_tokens_used_by_list(configuration: &configuration::Configuration, identifier: &str) -> Result<Vec<models::UsedBy>, Error<CoreTokensUsedByListError>> {
    ...
    let uri_str = format!("{}/core/tokens/{identifier}/used_by/", configuration.base_path, identifier=crate::apis::urlencode(p_path_identifier));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_tokens_view_key_retrieve(configuration: &configuration::Configuration, identifier: &str) -> Result<models::TokenView, Error<CoreTokensViewKeyRetrieveError>> {
    ...
    let uri_str = format!("{}/core/tokens/{identifier}/view_key/", configuration.base_path, identifier=crate::apis::urlencode(p_path_identifier));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::TokenView`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::TokenView`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn core_user_consent_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::UserConsent, Error<CoreUserConsentRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserConsent`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserConsent`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn core_user_consent_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<CoreUserConsentUsedByListError>> {
    ...
    let uri_str = format!("{}/core/user_consent/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_users_account_lockdown_create(configuration: &configuration::Configuration, user_account_lockdown_request: Option<models::UserAccountLockdownRequest>) -> Result<models::AccountLockdownFlowResponse, Error<CoreUsersAccountLockdownCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_user_account_lockdown_request = user_account_lockdown_request;

    let uri_str = format!("{}/core/users/account_lockdown/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_user_account_lockdown_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AccountLockdownFlowResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AccountLockdownFlowResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CoreUsersAccountLockdownCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn core_users_export_create(configuration: &configuration::Configuration, attributes: Option<&str>, date_joined: Option<String>, date_joined__gt: Option<String>, date_joined__lt: Option<String>, email: Option<&str>, groups_by_name: Option<Vec<String>>, groups_by_pk: Option<Vec<uuid::Uuid>>, is_active: Option<bool>, is_superuser: Option<bool>, last_login: Option<String>, last_login__gt: Option<String>, last_login__isnull: Option<bool>, last_login__lt: Option<String>, last_updated: Option<String>, last_updated__gt: Option<String>, last_updated__lt: Option<String>, name: Option<&str>, ordering: Option<&str>, path: Option<&str>, path_startswith: Option<&str>, roles_by_name: Option<Vec<String>>, roles_by_pk: Option<Vec<uuid::Uuid>>, search: Option<&str>, r#type: Option<Vec<models::UserTypeEnum>>, username: Option<&str>, uuid: Option<&str>) -> Result<models::DataExport, Error<CoreUsersExportCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_attributes = attributes;
    ...
    if let Some(ref param_value) = p_query_groups_by_name {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("groups_by_name".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("groups_by_name", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_groups_by_pk {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("groups_by_pk".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("groups_by_pk", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref param_value) = p_query_roles_by_name {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("roles_by_name".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("roles_by_name", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_roles_by_pk {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("roles_by_pk".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("roles_by_pk", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_search {
        req_builder = req_builder.query(&[("search", &param_value.to_string())]);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DataExport`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DataExport`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Impersonate a user
pub async fn core_users_impersonate_create(configuration: &configuration::Configuration, id: i32, impersonation_request: models::ImpersonationRequest) -> Result<(), Error<CoreUsersImpersonateCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_impersonation_request = impersonation_request;

    let uri_str = format!("{}/core/users/{id}/impersonate/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
>>>>>>> 0ab8796717 (gen: regenerate schema and clients)
/// User Viewset
pub async fn core_users_list(configuration: &configuration::Configuration, attributes: Option<&str>, date_joined: Option<String>, date_joined__gt: Option<String>, date_joined__lt: Option<String>, email: Option<&str>, groups_by_name: Option<Vec<String>>, groups_by_pk: Option<Vec<uuid::Uuid>>, include_groups: Option<bool>, include_roles: Option<bool>, is_active: Option<bool>, is_superuser: Option<bool>, last_login: Option<String>, last_login__gt: Option<String>, last_login__isnull: Option<bool>, last_login__lt: Option<String>, last_updated: Option<String>, last_updated__gt: Option<String>, last_updated__lt: Option<String>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, path: Option<&str>, path_startswith: Option<&str>, roles_by_name: Option<Vec<String>>, roles_by_pk: Option<Vec<uuid::Uuid>>, search: Option<&str>, r#type: Option<Vec<models::UserTypeEnum>>, username: Option<&str>, uuid: Option<&str>) -> Result<models::PaginatedUserList, Error<CoreUsersListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_attributes = attributes;
    let p_query_date_joined = date_joined;
    let p_query_date_joined__gt = date_joined__gt;
...
pub async fn core_users_paths_retrieve(configuration: &configuration::Configuration, search: Option<&str>) -> Result<models::UserPath, Error<CoreUsersPathsRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserPath`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserPath`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn core_users_recovery_create(configuration: &configuration::Configuration, id: i32, user_recovery_link_request: Option<models::UserRecoveryLinkRequest>) -> Result<models::Link, Error<CoreUsersRecoveryCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn core_users_recovery_email_create(configuration: &configuration::Configuration, id: i32, user_recovery_email_request: models::UserRecoveryEmailRequest) -> Result<(), Error<CoreUsersRecoveryEmailCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_user_recovery_email_request = user_recovery_email_request;

    let uri_str = format!("{}/core/users/{id}/recovery_email/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn core_users_set_password_create(configuration: &configuration::Configuration, id: i32, user_password_set_request: models::UserPasswordSetRequest) -> Result<(), Error<CoreUsersSetPasswordCreateError>> {
    ...
    let uri_str = format!("{}/core/users/{id}/set_password/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
