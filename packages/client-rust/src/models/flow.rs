...
pub struct Flow {
    ...
    #[serde(rename = "background_themed_urls", deserialize_with = "Option::deserialize")]
...
impl Flow {
    /// Flow Serializer
    pub fn new(pk: uuid::Uuid, policybindingmodel_ptr_id: uuid::Uuid, name: String, slug: String, title: String, designation: models::FlowDesignationEnum, background_url: String, background_themed_urls: Option<models::ThemedUrls>, stages: Vec<uuid::Uuid>, policies: Vec<uuid::Uuid>, cache_count: i32, export_url: String) -> Flow {
        Flow {
            pk,
