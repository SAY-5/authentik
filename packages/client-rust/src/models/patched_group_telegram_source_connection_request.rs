...
pub struct PatchedGroupTelegramSourceConnectionRequest {
...
impl PatchedGroupTelegramSourceConnectionRequest {
    /// Group Source Connection
    pub fn new() -> PatchedGroupTelegramSourceConnectionRequest {
