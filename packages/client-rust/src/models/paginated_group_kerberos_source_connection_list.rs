...
impl PaginatedGroupKerberosSourceConnectionList {
    pub fn new(pagination: models::Pagination, results: Vec<models::GroupKerberosSourceConnection>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedGroupKerberosSourceConnectionList {
