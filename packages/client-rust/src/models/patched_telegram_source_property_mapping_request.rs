...
pub struct PatchedTelegramSourcePropertyMappingRequest {
...
impl PatchedTelegramSourcePropertyMappingRequest {
    /// TelegramSourcePropertyMapping Serializer
    pub fn new() -> PatchedTelegramSourcePropertyMappingRequest {
