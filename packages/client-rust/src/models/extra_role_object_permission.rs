...
impl ExtraRoleObjectPermission {
    ...
    pub fn new(id: i32, codename: String, model: String, app_label: String, object_pk: String, name: String, app_label_verbose: String, model_verbose: String, object_description: Option<String>) -> ExtraRoleObjectPermission {
