...
impl PaginatedNotificationList {
    pub fn new(pagination: models::Pagination, results: Vec<models::Notification>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedNotificationList {
