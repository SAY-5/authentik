...
impl PaginatedKubernetesServiceConnectionList {
    pub fn new(pagination: models::Pagination, results: Vec<models::KubernetesServiceConnection>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedKubernetesServiceConnectionList {
