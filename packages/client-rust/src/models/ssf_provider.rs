...
pub struct SsfProvider {
    ...
    #[serde(rename = "push_verify_certificates", skip_serializing_if = "Option::is_none")]
    pub push_verify_certificates: Option<bool>,
}

impl SsfProvider {
    /// SSFProvider Serializer
    pub fn new(pk: i32, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, signing_key: uuid::Uuid, token_obj: models::Token, oidc_auth_providers_obj: Vec<models::Provider>, ssf_url: Option<String>) -> SsfProvider {
        SsfProvider {
            pk,
            name,
            component,
