...
impl PaginatedUserLdapSourceConnectionList {
    pub fn new(pagination: models::Pagination, results: Vec<models::UserLdapSourceConnection>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedUserLdapSourceConnectionList {
