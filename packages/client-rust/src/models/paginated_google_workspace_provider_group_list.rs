...
impl PaginatedGoogleWorkspaceProviderGroupList {
    pub fn new(pagination: models::Pagination, results: Vec<models::GoogleWorkspaceProviderGroup>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedGoogleWorkspaceProviderGroupList {
