...
impl PaginatedEndpointList {
    pub fn new(pagination: models::Pagination, results: Vec<models::Endpoint>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedEndpointList {
