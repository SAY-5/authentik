...
impl FlowSet {
    ...
    pub fn new(pk: uuid::Uuid, policybindingmodel_ptr_id: uuid::Uuid, name: String, slug: String, title: String, designation: models::FlowDesignationEnum, background_url: String, export_url: String) -> FlowSet {
        FlowSet {
            pk,
