...
pub struct RedirectStage {
    ...
    #[serde(rename = "target_flow", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub target_flow: Option<Option<uuid::Uuid>>,
}

impl RedirectStage {
    /// RedirectStage Serializer
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, flow_set: Vec<models::FlowSet>, mode: models::RedirectStageModeEnum) -> RedirectStage {
        RedirectStage {
            pk,
            name,
            component,
