...
impl PaginatedUserDeleteStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::UserDeleteStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedUserDeleteStageList {
