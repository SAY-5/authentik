...
impl LicenseSummary {
    ...
    pub fn new(internal_users: i32, external_users: i32, status: models::LicenseSummaryStatusEnum, latest_valid: String, license_flags: Vec<models::LicenseFlagsEnum>) -> LicenseSummary {
        LicenseSummary {
            internal_users,
            external_users,
            status,
