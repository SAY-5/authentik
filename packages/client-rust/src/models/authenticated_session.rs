...
impl AuthenticatedSession {
    ...
    pub fn new(current: bool, user_agent: models::AuthenticatedSessionUserAgent, geo_ip: Option<models::AuthenticatedSessionGeoIp>, asn: Option<models::AuthenticatedSessionAsn>, user: i32, last_ip: String, last_user_agent: String, last_used: String, expires: String) -> AuthenticatedSession {
