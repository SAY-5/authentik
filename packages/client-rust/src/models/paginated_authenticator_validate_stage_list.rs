...
impl PaginatedAuthenticatorValidateStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::AuthenticatorValidateStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedAuthenticatorValidateStageList {
