...
impl PaginatedLdapSourcePropertyMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::LdapSourcePropertyMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedLdapSourcePropertyMappingList {
