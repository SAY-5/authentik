...
impl SamlPropertyMapping {
    ...
    pub fn new(pk: uuid::Uuid, name: String, expression: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, saml_name: String) -> SamlPropertyMapping {
        SamlPropertyMapping {
            pk,
            managed: None,
            name,
