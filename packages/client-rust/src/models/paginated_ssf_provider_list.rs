...
impl PaginatedSsfProviderList {
    pub fn new(pagination: models::Pagination, results: Vec<models::SsfProvider>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedSsfProviderList {
