...
pub struct PatchedGoogleWorkspaceProviderMappingRequest {
...
impl PatchedGoogleWorkspaceProviderMappingRequest {
    /// GoogleWorkspaceProviderMapping Serializer
    pub fn new() -> PatchedGoogleWorkspaceProviderMappingRequest {
