...
impl GoogleWorkspaceProviderRequest {
    ...
    pub fn new(name: String, delegated_subject: String, credentials: std::collections::HashMap<String, serde_json::Value>, default_group_email_domain: String) -> GoogleWorkspaceProviderRequest {
