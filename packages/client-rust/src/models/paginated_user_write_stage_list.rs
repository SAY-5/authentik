...
impl PaginatedUserWriteStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::UserWriteStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedUserWriteStageList {
