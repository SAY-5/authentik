...
impl PaginatedConnectionTokenList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ConnectionToken>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedConnectionTokenList {
