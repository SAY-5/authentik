...
impl AuthenticatorWebAuthnStage {
    ...
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, flow_set: Vec<models::FlowSet>, device_type_restrictions_obj: Vec<models::WebAuthnDeviceType>) -> AuthenticatorWebAuthnStage {
