...
impl Task {
    pub fn new(actor_name: String, rel_obj_app_label: String, rel_obj_model: String, uid: String, logs: Vec<models::LogEvent>, previous_logs: Vec<models::LogEvent>, aggregated_status: models::TaskAggregatedStatusEnum, description: Option<String>) -> Task {
        Task {
            message_id: None,
            queue_name: None,
            actor_name,
