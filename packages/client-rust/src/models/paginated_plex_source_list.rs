...
impl PaginatedPlexSourceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::PlexSource>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedPlexSourceList {
