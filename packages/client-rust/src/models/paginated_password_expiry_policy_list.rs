...
impl PaginatedPasswordExpiryPolicyList {
    pub fn new(pagination: models::Pagination, results: Vec<models::PasswordExpiryPolicy>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedPasswordExpiryPolicyList {
