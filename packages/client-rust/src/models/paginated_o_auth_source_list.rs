...
impl PaginatedOAuthSourceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::OAuthSource>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedOAuthSourceList {
