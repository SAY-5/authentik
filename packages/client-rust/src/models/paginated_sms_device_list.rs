...
impl PaginatedSmsDeviceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::SmsDevice>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedSmsDeviceList {
