...
impl PaginatedPasswordStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::PasswordStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedPasswordStageList {
