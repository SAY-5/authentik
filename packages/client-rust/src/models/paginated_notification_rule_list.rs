...
impl PaginatedNotificationRuleList {
    pub fn new(pagination: models::Pagination, results: Vec<models::NotificationRule>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedNotificationRuleList {
