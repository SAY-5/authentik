...
pub struct PatchedRadiusProviderPropertyMappingRequest {
...
impl PatchedRadiusProviderPropertyMappingRequest {
    /// RadiusProviderPropertyMapping Serializer
    pub fn new() -> PatchedRadiusProviderPropertyMappingRequest {
