...
impl PaginatedGoogleWorkspaceProviderUserList {
    pub fn new(pagination: models::Pagination, results: Vec<models::GoogleWorkspaceProviderUser>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedGoogleWorkspaceProviderUserList {
