...
impl DataExport {
    ...
    pub fn new(id: uuid::Uuid, requested_by: models::PartialUser, requested_on: String, content_type: models::ContentType, query_params: std::collections::HashMap<String, serde_json::Value>, file_url: String, completed: bool) -> DataExport {
        DataExport {
            id,
            requested_by,
            requested_on,
