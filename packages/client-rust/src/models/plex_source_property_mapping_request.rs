...
pub struct PlexSourcePropertyMappingRequest {
...
impl PlexSourcePropertyMappingRequest {
    /// PlexSourcePropertyMapping Serializer
    pub fn new(name: String, expression: String) -> PlexSourcePropertyMappingRequest {
