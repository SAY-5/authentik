...
impl SourceType {
    ...
    pub fn new(name: String, verbose_name: String, urls_customizable: bool, request_token_url: Option<String>, authorization_url: Option<String>, access_token_url: Option<String>, profile_url: Option<String>, oidc_well_known_url: Option<String>, oidc_jwks_url: Option<String>) -> SourceType {
        SourceType {
            name,
            verbose_name,
            urls_customizable,
