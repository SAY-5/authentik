...
impl AgentConfig {
    ...
    pub fn new(device_id: String, refresh_interval: i32, authorization_flow: Option<String>, jwks_auth: std::collections::HashMap<String, serde_json::Value>, jwks_challenge: Option<std::collections::HashMap<String, serde_json::Value>>, nss_uid_offset: i32, nss_gid_offset: i32, auth_terminate_session_on_expiry: bool, system_config: models::Config, license_status: Option<models::LicenseStatusEnum>) -> AgentConfig {
        AgentConfig {
            device_id,
            refresh_interval,
            authorization_flow,
