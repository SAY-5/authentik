...
impl PaginatedInvitationStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::InvitationStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedInvitationStageList {
