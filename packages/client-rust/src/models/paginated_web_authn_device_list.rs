...
impl PaginatedWebAuthnDeviceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::WebAuthnDevice>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedWebAuthnDeviceList {
