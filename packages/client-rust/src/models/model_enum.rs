...
impl std::fmt::Display for ModelEnum {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::AuthentikEndpointsConnectorsAgentAgentconnector => write!(f, "authentik_endpoints_connectors_agent.agentconnector"),
            Self::AuthentikEndpointsConnectorsAgentAgentdeviceuserbinding => write!(f, "authentik_endpoints_connectors_agent.agentdeviceuserbinding"),
            Self::AuthentikEndpointsConnectorsAgentEnrollmenttoken => write!(f, "authentik_endpoints_connectors_agent.enrollmenttoken"),
            ...
            Self::AuthentikOutpostsKubernetesserviceconnection => write!(f, "authentik_outposts.kubernetesserviceconnection"),
            ...
            Self::AuthentikPoliciesEventMatcherEventmatcherpolicy => write!(f, "authentik_policies_event_matcher.eventmatcherpolicy"),
            Self::AuthentikPoliciesExpiryPasswordexpirypolicy => write!(f, "authentik_policies_expiry.passwordexpirypolicy"),
            Self::AuthentikPoliciesExpressionExpressionpolicy => write!(f, "authentik_policies_expression.expressionpolicy"),
            ...
            Self::AuthentikPoliciesReputationReputationpolicy => write!(f, "authentik_policies_reputation.reputationpolicy"),
            ...
            Self::AuthentikProvidersRadiusRadiusproviderpropertymapping => write!(f, "authentik_providers_radius.radiusproviderpropertymapping"),
            Self::AuthentikProvidersSamlSamlprovider => write!(f, "authentik_providers_saml.samlprovider"),
            Self::AuthentikProvidersSamlSamlpropertymapping => write!(f, "authentik_providers_saml.samlpropertymapping"),
            ...
            Self::AuthentikSourcesKerberosKerberossourcepropertymapping => write!(f, "authentik_sources_kerberos.kerberossourcepropertymapping"),
            Self::AuthentikSourcesKerberosUserkerberossourceconnection => write!(f, "authentik_sources_kerberos.userkerberossourceconnection"),
            Self::AuthentikSourcesKerberosGroupkerberossourceconnection => write!(f, "authentik_sources_kerberos.groupkerberossourceconnection"),
            Self::AuthentikSourcesLdapLdapsource => write!(f, "authentik_sources_ldap.ldapsource"),
            Self::AuthentikSourcesLdapLdapsourcepropertymapping => write!(f, "authentik_sources_ldap.ldapsourcepropertymapping"),
            Self::AuthentikSourcesLdapUserldapsourceconnection => write!(f, "authentik_sources_ldap.userldapsourceconnection"),
            Self::AuthentikSourcesLdapGroupldapsourceconnection => write!(f, "authentik_sources_ldap.groupldapsourceconnection"),
            Self::AuthentikSourcesOauthOauthsource => write!(f, "authentik_sources_oauth.oauthsource"),
            Self::AuthentikSourcesOauthOauthsourcepropertymapping => write!(f, "authentik_sources_oauth.oauthsourcepropertymapping"),
            Self::AuthentikSourcesOauthUseroauthsourceconnection => write!(f, "authentik_sources_oauth.useroauthsourceconnection"),
            Self::AuthentikSourcesOauthGroupoauthsourceconnection => write!(f, "authentik_sources_oauth.groupoauthsourceconnection"),
            Self::AuthentikSourcesPlexPlexsource => write!(f, "authentik_sources_plex.plexsource"),
            Self::AuthentikSourcesPlexPlexsourcepropertymapping => write!(f, "authentik_sources_plex.plexsourcepropertymapping"),
            Self::AuthentikSourcesPlexUserplexsourceconnection => write!(f, "authentik_sources_plex.userplexsourceconnection"),
            Self::AuthentikSourcesPlexGroupplexsourceconnection => write!(f, "authentik_sources_plex.groupplexsourceconnection"),
            Self::AuthentikSourcesSamlSamlsource => write!(f, "authentik_sources_saml.samlsource"),
            Self::AuthentikSourcesSamlSamlsourcepropertymapping => write!(f, "authentik_sources_saml.samlsourcepropertymapping"),
            Self::AuthentikSourcesSamlUsersamlsourceconnection => write!(f, "authentik_sources_saml.usersamlsourceconnection"),
            Self::AuthentikSourcesSamlGroupsamlsourceconnection => write!(f, "authentik_sources_saml.groupsamlsourceconnection"),
            Self::AuthentikSourcesScimScimsource => write!(f, "authentik_sources_scim.scimsource"),
            Self::AuthentikSourcesScimScimsourcepropertymapping => write!(f, "authentik_sources_scim.scimsourcepropertymapping"),
            Self::AuthentikSourcesTelegramTelegramsource => write!(f, "authentik_sources_telegram.telegramsource"),
            Self::AuthentikSourcesTelegramTelegramsourcepropertymapping => write!(f, "authentik_sources_telegram.telegramsourcepropertymapping"),
            Self::AuthentikSourcesTelegramUsertelegramsourceconnection => write!(f, "authentik_sources_telegram.usertelegramsourceconnection"),
            Self::AuthentikSourcesTelegramGrouptelegramsourceconnection => write!(f, "authentik_sources_telegram.grouptelegramsourceconnection"),
            Self::AuthentikStagesAuthenticatorDuoAuthenticatorduostage => write!(f, "authentik_stages_authenticator_duo.authenticatorduostage"),
            Self::AuthentikStagesAuthenticatorDuoDuodevice => write!(f, "authentik_stages_authenticator_duo.duodevice"),
            Self::AuthentikStagesAuthenticatorEmailAuthenticatoremailstage => write!(f, "authentik_stages_authenticator_email.authenticatoremailstage"),
            Self::AuthentikStagesAuthenticatorEmailEmaildevice => write!(f, "authentik_stages_authenticator_email.emaildevice"),
            Self::AuthentikStagesAuthenticatorSmsAuthenticatorsmsstage => write!(f, "authentik_stages_authenticator_sms.authenticatorsmsstage"),
            Self::AuthentikStagesAuthenticatorSmsSmsdevice => write!(f, "authentik_stages_authenticator_sms.smsdevice"),
            Self::AuthentikStagesAuthenticatorStaticAuthenticatorstaticstage => write!(f, "authentik_stages_authenticator_static.authenticatorstaticstage"),
            Self::AuthentikStagesAuthenticatorStaticStaticdevice => write!(f, "authentik_stages_authenticator_static.staticdevice"),
            ...
            Self::AuthentikStagesAuthenticatorTotpTotpdevice => write!(f, "authentik_stages_authenticator_totp.totpdevice"),
            Self::AuthentikStagesAuthenticatorValidateAuthenticatorvalidatestage => write!(f, "authentik_stages_authenticator_validate.authenticatorvalidatestage"),
            Self::AuthentikStagesAuthenticatorWebauthnAuthenticatorwebauthnstage => write!(f, "authentik_stages_authenticator_webauthn.authenticatorwebauthnstage"),
            Self::AuthentikStagesAuthenticatorWebauthnWebauthndevice => write!(f, "authentik_stages_authenticator_webauthn.webauthndevice"),
            ...
            Self::AuthentikStagesIdentificationIdentificationstage => write!(f, "authentik_stages_identification.identificationstage"),
            ...
            Self::AuthentikEndpointsConnectorsFleetFleetconnector => write!(f, "authentik_endpoints_connectors_fleet.fleetconnector"),
            Self::AuthentikEndpointsConnectorsGoogleChromeGooglechromeconnector => write!(f, "authentik_endpoints_connectors_google_chrome.googlechromeconnector"),
            ...
            Self::AuthentikPoliciesUniquePasswordUniquepasswordpolicy => write!(f, "authentik_policies_unique_password.uniquepasswordpolicy"),
            Self::AuthentikProvidersGoogleWorkspaceGoogleworkspaceprovider => write!(f, "authentik_providers_google_workspace.googleworkspaceprovider"),
            Self::AuthentikProvidersGoogleWorkspaceGoogleworkspaceprovidermapping => write!(f, "authentik_providers_google_workspace.googleworkspaceprovidermapping"),
            Self::AuthentikProvidersMicrosoftEntraMicrosoftentraprovider => write!(f, "authentik_providers_microsoft_entra.microsoftentraprovider"),
            Self::AuthentikProvidersMicrosoftEntraMicrosoftentraprovidermapping => write!(f, "authentik_providers_microsoft_entra.microsoftentraprovidermapping"),
            Self::AuthentikProvidersSsfSsfprovider => write!(f, "authentik_providers_ssf.ssfprovider"),
            Self::AuthentikProvidersWsFederationWsfederationprovider => write!(f, "authentik_providers_ws_federation.wsfederationprovider"),
            Self::AuthentikReportsDataexport => write!(f, "authentik_reports.dataexport"),
            Self::AuthentikStagesAccountLockdownAccountlockdownstage => write!(f, "authentik_stages_account_lockdown.accountlockdownstage"),
            Self::AuthentikStagesAuthenticatorEndpointGdtcAuthenticatorendpointgdtcstage => write!(f, "authentik_stages_authenticator_endpoint_gdtc.authenticatorendpointgdtcstage"),
