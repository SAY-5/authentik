...
impl std::fmt::Display for AppEnum {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::AuthentikEnterpriseEndpointsConnectorsAgent => write!(f, "authentik.enterprise.endpoints.connectors.agent"),
            Self::AuthentikEnterpriseEndpointsConnectorsFleet => write!(f, "authentik.enterprise.endpoints.connectors.fleet"),
            Self::AuthentikEnterpriseEndpointsConnectorsGoogleChrome => write!(f, "authentik.enterprise.endpoints.connectors.google_chrome"),
            Self::AuthentikEnterpriseLifecycle => write!(f, "authentik.enterprise.lifecycle"),
            Self::AuthentikEnterprisePoliciesUniquePassword => write!(f, "authentik.enterprise.policies.unique_password"),
            Self::AuthentikEnterpriseProvidersGoogleWorkspace => write!(f, "authentik.enterprise.providers.google_workspace"),
            Self::AuthentikEnterpriseProvidersMicrosoftEntra => write!(f, "authentik.enterprise.providers.microsoft_entra"),
            ...
            Self::AuthentikEnterpriseStagesAuthenticatorEndpointGdtc => write!(f, "authentik.enterprise.stages.authenticator_endpoint_gdtc"),
