...
impl PaginatedApplicationEntitlementList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ApplicationEntitlement>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedApplicationEntitlementList {
