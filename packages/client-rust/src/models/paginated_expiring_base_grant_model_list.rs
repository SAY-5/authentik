...
impl PaginatedExpiringBaseGrantModelList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ExpiringBaseGrantModel>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedExpiringBaseGrantModelList {
