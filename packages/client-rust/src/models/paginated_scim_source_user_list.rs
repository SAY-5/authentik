...
impl PaginatedScimSourceUserList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ScimSourceUser>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedScimSourceUserList {
