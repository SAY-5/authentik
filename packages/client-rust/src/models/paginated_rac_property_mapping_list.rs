...
impl PaginatedRacPropertyMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::RacPropertyMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedRacPropertyMappingList {
