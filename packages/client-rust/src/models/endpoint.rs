...
impl Endpoint {
    /// Endpoint Serializer
    pub fn new(pk: uuid::Uuid, name: String, provider: i32, provider_obj: models::RacProvider, protocol: models::ProtocolEnum, host: String, auth_mode: models::EndpointAuthModeEnum, launch_url: Option<String>) -> Endpoint {
        Endpoint {
            pk,
            name,
            provider,
