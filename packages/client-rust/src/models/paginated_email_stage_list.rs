...
impl PaginatedEmailStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::EmailStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedEmailStageList {
