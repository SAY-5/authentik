...
impl SystemInfoRuntime {
    /// Get versions
    pub fn new(python_version: String, environment: String, architecture: String, platform: String, uname: String, openssl_version: String, openssl_fips_enabled: Option<bool>, authentik_version: String) -> SystemInfoRuntime {
        SystemInfoRuntime {
            python_version,
            environment,
            architecture,
