...
impl PaginatedProviderList {
    pub fn new(pagination: models::Pagination, results: Vec<models::Provider>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedProviderList {
