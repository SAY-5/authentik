...
impl PaginatedUserLoginStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::UserLoginStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedUserLoginStageList {
