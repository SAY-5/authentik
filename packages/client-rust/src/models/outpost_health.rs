...
impl OutpostHealth {
    ...
    pub fn new(uid: String, last_seen: String, version: String, golang_version: String, openssl_enabled: bool, openssl_version: String, fips_enabled: Option<bool>, version_should: String, version_outdated: bool, build_hash: String, build_hash_should: String, hostname: String) -> OutpostHealth {
        OutpostHealth {
            uid,
            last_seen,
            version,
