...
impl CurrentBrandFlags {
    pub fn new(core_default_app_access: bool, enterprise_audit_include_expanded_diff: bool, flows_continuous_login: bool, flows_refresh_others: bool) -> CurrentBrandFlags {
        CurrentBrandFlags {
