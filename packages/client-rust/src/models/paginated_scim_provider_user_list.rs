...
impl PaginatedScimProviderUserList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ScimProviderUser>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedScimProviderUserList {
