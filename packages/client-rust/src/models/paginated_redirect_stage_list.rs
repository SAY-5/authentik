...
impl PaginatedRedirectStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::RedirectStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedRedirectStageList {
