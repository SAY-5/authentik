...
impl PaginatedSamlSourceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::SamlSource>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedSamlSourceList {
