...
pub struct WsFederationProvider {
    ...
    #[serde(rename = "authn_context_class_ref_mapping", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "encryption_kp", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
