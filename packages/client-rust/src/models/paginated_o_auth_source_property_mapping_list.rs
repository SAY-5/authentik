...
impl PaginatedOAuthSourcePropertyMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::OAuthSourcePropertyMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedOAuthSourcePropertyMappingList {
