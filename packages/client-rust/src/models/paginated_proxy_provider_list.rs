...
impl PaginatedProxyProviderList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ProxyProvider>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedProxyProviderList {
