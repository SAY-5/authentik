...
impl PaginatedIdentificationStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::IdentificationStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedIdentificationStageList {
