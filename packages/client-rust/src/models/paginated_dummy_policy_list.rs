...
impl PaginatedDummyPolicyList {
    pub fn new(pagination: models::Pagination, results: Vec<models::DummyPolicy>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedDummyPolicyList {
