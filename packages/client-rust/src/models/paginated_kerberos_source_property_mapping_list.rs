...
impl PaginatedKerberosSourcePropertyMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::KerberosSourcePropertyMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedKerberosSourcePropertyMappingList {
