...
impl GeoIpPolicy {
    ...
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, bound_to: i32, countries: Vec<models::CountryCodeEnum>, countries_obj: Vec<models::GeoIpPolicyCountriesObjInner>) -> GeoIpPolicy {
        GeoIpPolicy {
            pk,
            name,
