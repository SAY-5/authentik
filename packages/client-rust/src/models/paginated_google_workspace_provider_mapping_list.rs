...
impl PaginatedGoogleWorkspaceProviderMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::GoogleWorkspaceProviderMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedGoogleWorkspaceProviderMappingList {
