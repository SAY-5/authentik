...
impl PaginatedPromptStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::PromptStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedPromptStageList {
