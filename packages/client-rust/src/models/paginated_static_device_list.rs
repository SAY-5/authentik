...
impl PaginatedStaticDeviceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::StaticDevice>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedStaticDeviceList {
