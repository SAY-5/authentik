...
impl PaginatedUserLogoutStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::UserLogoutStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedUserLogoutStageList {
