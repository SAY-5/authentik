...
impl PaginatedExpressionPolicyList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ExpressionPolicy>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedExpressionPolicyList {
