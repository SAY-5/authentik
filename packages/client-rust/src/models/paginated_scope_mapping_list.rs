...
impl PaginatedScopeMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ScopeMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedScopeMappingList {
