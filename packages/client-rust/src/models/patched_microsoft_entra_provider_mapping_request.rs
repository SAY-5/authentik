...
pub struct PatchedMicrosoftEntraProviderMappingRequest {
...
impl PatchedMicrosoftEntraProviderMappingRequest {
    /// MicrosoftEntraProviderMapping Serializer
    pub fn new() -> PatchedMicrosoftEntraProviderMappingRequest {
