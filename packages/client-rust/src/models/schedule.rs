...
pub struct Schedule {
    ...
    #[serde(rename = "rel_obj_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl Schedule {
    pub fn new(id: uuid::Uuid, identifier: Option<String>, uid: String, actor_name: String, rel_obj_app_label: String, rel_obj_model: String, crontab: String, next_run: String, description: Option<String>, last_task_status: Option<models::LastTaskStatusEnum>) -> Schedule {
        Schedule {
            id,
            identifier,
            uid,
