...
pub struct UniquePasswordPolicy {
    #[serde(rename = "pk")]
    pub pk: uuid::Uuid,
    #[serde(rename = "name")]
    pub name: String,
...
impl UniquePasswordPolicy {
    /// Password Uniqueness Policy Serializer
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, bound_to: i32) -> UniquePasswordPolicy {
