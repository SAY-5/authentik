...
impl TelegramSource {
    /// Source Serializer
    pub fn new(pk: uuid::Uuid, name: String, slug: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, managed: Option<String>, icon_url: Option<String>, icon_themed_urls: Option<models::ThemedUrls>, bot_username: String, pre_authentication_flow: uuid::Uuid) -> TelegramSource {
        TelegramSource {
            pk,
            name,
            slug,
