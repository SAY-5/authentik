...
pub struct ScimProvider {
    ...
    #[serde(rename = "assigned_backchannel_application_slug", deserialize_with = "Option::deserialize")]
    pub assigned_backchannel_application_slug: Option<String>,
    /// Application's display Name.
    #[serde(rename = "assigned_backchannel_application_name", deserialize_with = "Option::deserialize")]
    ...
    #[serde(rename = "auth_oauth", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "service_provider_config_cache_timeout", skip_serializing_if = "Option::is_none")]
...
impl ScimProvider {
    ...
    pub fn new(pk: i32, name: String, component: String, assigned_backchannel_application_slug: Option<String>, assigned_backchannel_application_name: Option<String>, verbose_name: String, verbose_name_plural: String, meta_model_name: String, url: String) -> ScimProvider {
        ScimProvider {
            pk,
            name,
