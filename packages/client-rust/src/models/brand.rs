...
pub struct Brand {
    ...
    #[serde(rename = "flow_lockdown", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub flow_lockdown: Option<Option<uuid::Uuid>>,
    /// Required level of authentication and authorization to access a flow.
    #[serde(rename = "flow_lockdown_authentication", deserialize_with = "Option::deserialize")]
    pub flow_lockdown_authentication: Option<models::AuthenticationEnum>,
    /// When set, external users will be redirected to this application after authenticating.
    #[serde(rename = "default_application", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl Brand {
    /// Brand Serializer
    pub fn new(brand_uuid: uuid::Uuid, domain: String, flow_lockdown_authentication: Option<models::AuthenticationEnum>) -> Brand {
        Brand {
            brand_uuid,
            domain,
            default: None,
