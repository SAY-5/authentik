...
impl AuthenticatorDuoStage {
    ...
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, flow_set: Vec<models::FlowSet>, client_id: String, api_hostname: String) -> AuthenticatorDuoStage {
