...
impl PaginatedEndpointDeviceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::EndpointDevice>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedEndpointDeviceList {
