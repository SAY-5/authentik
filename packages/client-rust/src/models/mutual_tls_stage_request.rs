...
impl MutualTlsStageRequest {
    ...
    pub fn new(name: String, mode: models::StageModeEnum, cert_attribute: models::CertAttributeEnum, user_attribute: models::UserAttributeEnum) -> MutualTlsStageRequest {
