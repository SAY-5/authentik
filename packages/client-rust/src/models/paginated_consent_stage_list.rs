...
impl PaginatedConsentStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ConsentStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedConsentStageList {
