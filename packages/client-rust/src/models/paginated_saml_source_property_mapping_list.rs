...
impl PaginatedSamlSourcePropertyMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::SamlSourcePropertyMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedSamlSourcePropertyMappingList {
