...
impl ScimSource {
    ...
    pub fn new(pk: uuid::Uuid, name: String, slug: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, managed: Option<String>, root_url: String, token_obj: models::Token) -> ScimSource {
        ScimSource {
            pk,
            name,
            slug,
