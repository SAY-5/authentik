...
pub struct Application {
    ...
    #[serde(rename = "meta_icon_themed_urls", deserialize_with = "Option::deserialize")]
...
impl Application {
    ...
    pub fn new(pk: uuid::Uuid, name: String, slug: String, provider_obj: Option<models::Provider>, backchannel_providers_obj: Vec<models::Provider>, launch_url: Option<String>, meta_icon_url: Option<String>, meta_icon_themed_urls: Option<models::ThemedUrls>) -> Application {
        Application {
            pk,
            name,
            slug,
