...
impl PaginatedPasswordPolicyList {
    pub fn new(pagination: models::Pagination, results: Vec<models::PasswordPolicy>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedPasswordPolicyList {
