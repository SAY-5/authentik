...
pub struct IdentificationStage {
    ...
    #[serde(rename = "webauthn_stage", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub webauthn_stage: Option<Option<uuid::Uuid>>,
}

impl IdentificationStage {
    /// IdentificationStage Serializer
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, flow_set: Vec<models::FlowSet>) -> IdentificationStage {
        IdentificationStage {
            pk,
            name,
            component,
