...
pub struct CurrentBrand {
    ...
    #[serde(rename = "branding_logo_themed_urls", deserialize_with = "Option::deserialize")]
    pub branding_logo_themed_urls: Option<models::ThemedUrls>,
    #[serde(rename = "branding_favicon")]
    pub branding_favicon: String,
    #[serde(rename = "branding_favicon_themed_urls", deserialize_with = "Option::deserialize")]
...
impl CurrentBrand {
    ...
    pub fn new(matched_domain: String, branding_title: String, branding_logo: String, branding_logo_themed_urls: Option<models::ThemedUrls>, branding_favicon: String, branding_favicon_themed_urls: Option<models::ThemedUrls>, branding_custom_css: String, ui_footer_links: Vec<models::FooterLink>, ui_theme: models::UiThemeEnum, default_locale: String, flags: models::CurrentBrandFlags) -> CurrentBrand {
        CurrentBrand {
            matched_domain,
            branding_title,
            branding_logo,
