...
impl PaginatedAuthenticatorStaticStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::AuthenticatorStaticStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedAuthenticatorStaticStageList {
