...
impl PaginatedInvitationList {
    pub fn new(pagination: models::Pagination, results: Vec<models::Invitation>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedInvitationList {
