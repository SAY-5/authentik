...
impl PaginatedMicrosoftEntraProviderMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::MicrosoftEntraProviderMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedMicrosoftEntraProviderMappingList {
