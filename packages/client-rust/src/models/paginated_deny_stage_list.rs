...
impl PaginatedDenyStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::DenyStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedDenyStageList {
