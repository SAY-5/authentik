...
impl PaginatedDockerServiceConnectionList {
    pub fn new(pagination: models::Pagination, results: Vec<models::DockerServiceConnection>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedDockerServiceConnectionList {
