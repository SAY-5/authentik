...
pub struct TelegramSourcePropertyMappingRequest {
...
impl TelegramSourcePropertyMappingRequest {
    /// TelegramSourcePropertyMapping Serializer
    pub fn new(name: String, expression: String) -> TelegramSourcePropertyMappingRequest {
