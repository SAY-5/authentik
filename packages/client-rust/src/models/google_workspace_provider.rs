...
impl GoogleWorkspaceProvider {
    ...
    pub fn new(pk: i32, name: String, component: String, assigned_backchannel_application_slug: Option<String>, assigned_backchannel_application_name: Option<String>, verbose_name: String, verbose_name_plural: String, meta_model_name: String, delegated_subject: String, credentials: std::collections::HashMap<String, serde_json::Value>, default_group_email_domain: String) -> GoogleWorkspaceProvider {
