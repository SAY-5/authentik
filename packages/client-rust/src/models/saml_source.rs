...
impl SamlSource {
    ...
    pub fn new(pk: uuid::Uuid, name: String, slug: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, managed: Option<String>, icon_url: String, icon_themed_urls: Option<models::ThemedUrls>, pre_authentication_flow: uuid::Uuid, sso_url: String) -> SamlSource {
        SamlSource {
            pk,
            name,
            slug,
