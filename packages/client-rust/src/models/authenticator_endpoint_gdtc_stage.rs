...
pub struct AuthenticatorEndpointGdtcStage {
    #[serde(rename = "pk")]
    pub pk: uuid::Uuid,
    #[serde(rename = "name")]
    pub name: String,
...
impl AuthenticatorEndpointGdtcStage {
    /// AuthenticatorEndpointGDTCStage Serializer
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, flow_set: Vec<models::FlowSet>, credentials: std::collections::HashMap<String, serde_json::Value>) -> AuthenticatorEndpointGdtcStage {
