...
pub struct DeviceUserBinding {
    ...
    #[serde(rename = "connector", deserialize_with = "Option::deserialize")]
    pub connector: Option<uuid::Uuid>,
    #[serde(rename = "connector_obj")]
    pub connector_obj: models::Connector,
}

impl DeviceUserBinding {
    /// PolicyBinding Serializer
    pub fn new(pk: uuid::Uuid, policy_obj: Option<models::Policy>, group_obj: Option<models::PartialGroup>, user_obj: Option<models::PartialUser>, target: uuid::Uuid, order: i32, connector: Option<uuid::Uuid>, connector_obj: models::Connector) -> DeviceUserBinding {
        DeviceUserBinding {
            pk,
            policy: None,
            group: None,
