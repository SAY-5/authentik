...
impl PaginatedRadiusProviderPropertyMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::RadiusProviderPropertyMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedRadiusProviderPropertyMappingList {
