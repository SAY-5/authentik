...
impl PaginatedPropertyMappingList {
    pub fn new(pagination: models::Pagination, results: Vec<models::PropertyMapping>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedPropertyMappingList {
