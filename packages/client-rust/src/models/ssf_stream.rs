...
pub struct SsfStream {
    ...
    #[serde(rename = "endpoint_url", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl SsfStream {
    ...
    pub fn new(pk: uuid::Uuid, provider: i32, provider_obj: models::SsfProvider, delivery_method: models::DeliveryMethodEnum, format: String, iss: String) -> SsfStream {
        SsfStream {
            pk,
            status: None,
            provider,
