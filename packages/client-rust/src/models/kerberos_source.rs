...
pub struct KerberosSource {
    ...
    #[serde(rename = "password_login_update_internal_password", skip_serializing_if = "Option::is_none")]
...
impl KerberosSource {
    ...
    pub fn new(pk: uuid::Uuid, name: String, slug: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, managed: Option<String>, icon_url: String, icon_themed_urls: Option<models::ThemedUrls>, realm: String, connectivity: Option<std::collections::HashMap<String, String>>) -> KerberosSource {
        KerberosSource {
            pk,
            name,
            slug,
