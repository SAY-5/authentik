...
impl PaginatedKerberosSourceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::KerberosSource>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedKerberosSourceList {
