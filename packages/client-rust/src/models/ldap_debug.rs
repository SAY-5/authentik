...
impl LdapDebug {
    pub fn new(user: Vec<std::collections::HashMap<String, serde_json::Value>>, group: Vec<std::collections::HashMap<String, serde_json::Value>>, membership: Vec<std::collections::HashMap<String, serde_json::Value>>) -> LdapDebug {
        LdapDebug {
            user,
            group,
            membership,
