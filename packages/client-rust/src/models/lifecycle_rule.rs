...
impl LifecycleRule {
    ...
    pub fn new(id: uuid::Uuid, name: String, content_type: models::ContentTypeEnum, reviewer_groups_obj: Vec<models::ReviewerGroup>, reviewers: Vec<uuid::Uuid>, reviewers_obj: Vec<models::ReviewerUser>, target_verbose: String) -> LifecycleRule {
        LifecycleRule {
            id,
            name,
            content_type,
