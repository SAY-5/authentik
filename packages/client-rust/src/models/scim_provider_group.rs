...
impl ScimProviderGroup {
    ...
    pub fn new(id: uuid::Uuid, scim_id: String, group: uuid::Uuid, group_obj: models::PartialGroup, provider: i32, attributes: std::collections::HashMap<String, serde_json::Value>) -> ScimProviderGroup {
        ScimProviderGroup {
            id,
            scim_id,
            group,
