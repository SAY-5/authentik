...
pub struct Settings {
    ...
    #[serde(rename = "pagination_default_page_size", skip_serializing_if = "Option::is_none")]
    pub pagination_default_page_size: Option<u32>,
    /// Maximum page size
    #[serde(rename = "pagination_max_page_size", skip_serializing_if = "Option::is_none")]
...
impl Settings {
    /// Settings Serializer
    pub fn new(flags: models::PatchedSettingsRequestFlags) -> Settings {
        Settings {
            avatars: None,
