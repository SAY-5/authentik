...
impl PaginatedAuthenticatorSmsStageList {
    pub fn new(pagination: models::Pagination, results: Vec<models::AuthenticatorSmsStage>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedAuthenticatorSmsStageList {
