...
impl PaginatedReputationPolicyList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ReputationPolicy>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedReputationPolicyList {
