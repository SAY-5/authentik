...
pub struct AuthenticatorValidateStage {
    #[serde(rename = "pk")]
    pub pk: uuid::Uuid,
    #[serde(rename = "name")]
    pub name: String,
    ...
    pub webauthn_allowed_device_types_obj: Vec<models::WebAuthnDeviceType>,
}

impl AuthenticatorValidateStage {
    /// AuthenticatorValidateStage Serializer
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, flow_set: Vec<models::FlowSet>, webauthn_allowed_device_types_obj: Vec<models::WebAuthnDeviceType>) -> AuthenticatorValidateStage {
