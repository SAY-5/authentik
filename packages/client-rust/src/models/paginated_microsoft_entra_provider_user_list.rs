...
impl PaginatedMicrosoftEntraProviderUserList {
    pub fn new(pagination: models::Pagination, results: Vec<models::MicrosoftEntraProviderUser>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedMicrosoftEntraProviderUserList {
