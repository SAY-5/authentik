...
impl PaginatedTotpDeviceList {
    pub fn new(pagination: models::Pagination, results: Vec<models::TotpDevice>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedTotpDeviceList {
